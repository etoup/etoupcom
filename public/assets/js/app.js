...
function(t, e) {
    ...
    function n(t, e, i) {
        if (ot.isFunction(e)) return ot.grep(t,
        function(t, n) {
            return !! e.call(t, n, t) !== i
        });
        if (e.nodeType) return ot.grep(t,
        function(t) {
            return t === e !== i
        });
        if ("string" == typeof e) {
    ...
    function l(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType) if (n = "data-" + e.replace($t, "-$&").toLowerCase(), i = t.getAttribute(n), "string" == typeof i) {
            try {
                i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null: +i + "" === i ? +i: Pt.test(i) ? ot.parseJSON(i) : i
            } catch(r) {}
            St.set(t, e, i)
        } else i = void 0;
        return i
    ...
    function u(t, e, i, n) {
        ...
        return i && (c = +c || +l || 0, r = i[1] ? c + (i[1] + 1) * i[2] : +i[2], n && (n.unit = u, n.start = c, n.end = r)),
        r
    }
    function c(t, e) {
    ...
    function h(t, e) {
        for (var i = 0,
        n = t.length; n > i; i++) kt.set(t[i], "globalEval", !e || kt.get(e[i], "globalEval"))
    }
    function d(t, e, i, n, r) {
        for (var o, s, a, l, u, d, f = e.createDocumentFragment(), p = [], m = 0, g = t.length; g > m; m++) if (o = t[m], o || 0 === o) if ("object" === ot.type(o)) ot.merge(p, o.nodeType ? [o] : o);
        else if (Mt.test(o)) {
    ...
    function w(t, e) {
        ...
        if (1 === e.nodeType) {
            if (kt.hasData(t) && (o = kt.access(t), s = kt.set(e, o), u = o.events)) {
                delete s.handle,
                s.events = {};
                for (r in u) for (i = 0, n = u[r].length; n > i; i++) ot.event.add(e, r, u[r][i])
            }
    ...
    function x(t, e, i, n) {
        ...
        if (f && (r = d(e, t[0].ownerDocument, !1, t, n), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || n)) {
            for (s = ot.map(c(r, "script"), y), a = s.length; f > h; h++) l = r,
            h !== p && (l = ot.clone(l, !0, !0), a && ot.merge(s, c(l, "script"))),
            i.call(t[h], l, h);
            if (a) for (u = s[s.length - 1].ownerDocument, ot.map(s, _), h = 0; a > h; h++) l = s[h],
            Dt.test(l.type || "") && !kt.access(l, "globalEval") && ot.contains(u, l) && (l.src ? ot._evalUrl && ot._evalUrl(l.src) : ot.globalEval(l.textContent.replace(Vt, "")))
        }
        return t
    }
    function T(t, e, i) {
        for (var n, r = e ? ot.filter(e, t) : t, o = 0; null != (n = r[o]); o++) i || 1 !== n.nodeType || ot.cleanData(c(n)),
        n.parentNode && (i && ot.contains(n.ownerDocument, n) && h(c(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    function C(t, e) {
    ...
    function k(t) {
        var e = Q,
        i = Xt[t];
        return i || (i = C(t, e), "none" !== i && i || (Yt = (Yt || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Yt[0].contentDocument, e.write(), e.close(), i = C(t, e), Yt.detach()), Xt[t] = i),
        i
    }
    function S(t, e, i) {
        ...
        i && !nt.pixelMarginRight() && Qt.test(s) && Ut.test(e) && (n = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = r, a.maxWidth = o),
        void 0 !== s ? s + "": s
    }
    function P(t, e) {
        return {
    ...
    function A(t, e, i, n, r) {
        for (var o = i === (n ? "border": "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > o; o += 2)"margin" === i && (s += ot.css(t, i + Ft[o], !0, r)),
        n ? ("content" === i && (s -= ot.css(t, "padding" + Ft[o], !0, r)), "margin" !== i && (s -= ot.css(t, "border" + Ft[o] + "Width", !0, r))) : (s += ot.css(t, "padding" + Ft[o], !0, r), "padding" !== i && (s += ot.css(t, "border" + Ft[o] + "Width", !0, r)));
        return s
    }
    function F(t, e, i) {
        var n = !0,
        ...
        if (0 >= r || null == r) {
            if (r = S(t, e, o), (0 > r || null == r) && (r = t.style[e]), Qt.test(r)) return r;
    ...
    function E(t, e) {
        ...
        n.style && (o[s] = kt.get(n, "olddisplay"), i = n.style.display, e ? (o[s] || "none" !== i || (n.style.display = ""), "" === n.style.display && Et(n) && (o[s] = kt.access(n, "olddisplay", k(n.nodeName)))) : (r = Et(n), "none" === i && r || kt.set(n, "olddisplay", r ? i: ot.css(n, "display"))));
        for (s = 0; a > s; s++) n = t[s],
    ...
    function D(t, e) {
        ...
        for (e = e ? 1 : 0; 4 > n; n += 2 - e) i = Ft[n],
        r["margin" + i] = r["padding" + i] = t;
        return e && (r.opacity = r.width = t),
        r
    }
    function L(t, e, i) {
        for (var n, r = (j.tweeners[e] || []).concat(j.tweeners["*"]), o = 0, s = r.length; s > o; o++) if (n = r[o].call(i, e, t)) return n
    }
    function M(t, e, i) {
        ...
        1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [f.overflow, f.overflowX, f.overflowY], u = ot.css(t, "display"), c = "none" === u ? kt.get(t, "olddisplay") || k(t.nodeName) : u, "inline" === c && "none" === ot.css(t, "float") && (f.display = "inline-block")),
    ...
    function j(t, e, i) {
        ...
        l = function() {
            if (r) return ! 1;
            for (var e = re || R(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, o = 1 - n, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(o);
        ...
        c = u.props;
        for (I(c, u.opts.specialEasing); s > o; o++) if (n = j.prefilters[o].call(u, t, c, u.opts)) return ot.isFunction(n.stop) && (ot._queueHooks(u.elem, u.opts.queue).stop = ot.proxy(n.stop, n)),
        n;
        return ot.map(c, L, u),
    ...
    ot.extend = ot.fn.extend = function() {
        ...
        a++), "object" == typeof s || ot.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++) if (null != (t = arguments[a])) for (e in t) i = s[e],
        n = t[e],
        s !== n && (u && n && (ot.isPlainObject(n) || (r = ot.isArray(n))) ? (r ? (r = !1, o = i && ot.isArray(i) ? i: []) : o = i && ot.isPlainObject(i) ? i: {},
    ...
    ot.extend({
        ...
        globalEval: function(t) {
            var e, i = eval;
            t = ot.trim(t),
            t && (1 === t.indexOf("use strict") ? (e = Q.createElement("script"), e.text = t, Q.head.appendChild(e).parentNode.removeChild(e)) : i(t))
        },
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (i(Object(t)) ? ot.merge(n, "string" == typeof t ? [t] : t) : K.call(n, t)),
            n
        },
        ...
        map: function(t, e, n) {
            var r, o, s = 0,
            a = [];
            if (i(t)) for (r = t.length; r > s; s++) o = e(t[s], s, n),
            null != o && a.push(o);
        ...
        proxy: function(t, e) {
            ...
            ot.isFunction(t) ? (n = G.call(arguments, 2), r = function() {
    ...
    "function" == typeof Symbol && (ot.fn[Symbol.iterator] = U[Symbol.iterator]),
    ...
    var ct = function(t) {
            ...
            if (!n && ((e ? e.ownerDocument || e: N) !== E && F(e), e = e || E, R)) {
                if (11 !== m && (u = vt.exec(t))) if (r = u[1]) {
                    if (9 === m) {
                        ...
                        i
                    } else if (p && (s = p.getElementById(r)) && I(e, s) && s.id === r) return i.push(s),
                    i
                } else {
                    if (u[2]) return K.apply(i, e.getElementsByTagName(t)),
                    i;
                    if ((r = u[3]) && b.getElementsByClassName && e.getElementsByClassName) return K.apply(i, e.getElementsByClassName(r)),
                    i
                }
                if (b.qsa && !V[t + " "] && (!D || !D.test(t))) {
                    if (1 !== m) p = e,
                    f = t;
                    ...
                    if (f) try {
                        return K.apply(i, p.querySelectorAll(f)),
                        i
                    } catch(g) {} finally {
        ...
        function v(t, e, i, r, o, s) {
            ...
            n(function(n, s, a, l) {
                ...
                } else _ = g(_ === s ? _.splice(p, _.length) : _),
                o ? o(null, s, _, l) : K.apply(s, _)
            })
        }
        function y(t) {
            for (var e, i, n, r = t.length,
            o = x.relative[t[0].type], s = o || x.relative[" "], a = o ? 1 : 0, l = f(function(t) {
                return t === e
            },
            s, !0), u = f(function(t) {
                return tt(e, t) > -1
            ...
            s, !0), c = [function(t, i, n) {
                ...
                return e = null,
                r
            }]; r > a; a++) if (i = x.relative[t[a].type]) c = [f(p(c), i)];
            else {
                if (i = x.filter[t[a].type].apply(null, t[a].matches), i[j]) {
                    ...
                    return v(a > 1 && p(c), a > 1 && d(t.slice(0, a - 1).concat({
                        value: " " === t[a - 2].type ? "*": ""
                    })).replace(at, "$1"), i, n > a && y(t.slice(a, n)), r > n && y(t = t.slice(n)), r > n && d(t))
                }
                c.push(i)
            }
            return p(c)
        ...
        function _(t, i) {
            ...
            s = function(n, s, a, l, u) {
                ...
                b = _.length;
                for (u && ($ = s === E || s || u); p !== b && null != (c = _[p]); p++) {
                    if (o && c) {
        ...
        var w, b, x, T, C, k, S, P, $, O, A, F, E, z, R, D, L, M, I, j = "sizzle" + 1 * new Date,
        N = t.document,
        q = 0,
        H = 0,
        B = i(),
        ...
        try {
            K.apply(Q = J.call(N.childNodes), N.childNodes),
        ...
        F = e.setDocument = function(t) {
            ...
            return n !== E && 9 === n.nodeType && n.documentElement ? (E = n, z = E.documentElement, R = !C(E), (i = E.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", xt, !1) : i.attachEvent && i.attachEvent("onunload", xt)), b.attributes = r(function(t) {
            ...
            L = [], D = [], (b.qsa = gt.test(E.querySelectorAll)) && (r(function(t) {
                z.appendChild(t).innerHTML = "<a id='" + j + "'></a><select id='" + j + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && D.push("[*^$]=" + it + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || D.push("\\[" + it + "*(?:value|" + et + ")"),
                ...
                t.querySelectorAll("[name=d]").length && D.push("name" + it + "*[*^$|!~]?="),
                t.querySelectorAll(":enabled").length || D.push(":enabled", ":disabled"),
                t.querySelectorAll("*,:x"),
                D.push(",.*:")
            })), (b.matchesSelector = gt.test(M = z.matches || z.webkitMatchesSelector || z.mozMatchesSelector || z.oMatchesSelector || z.msMatchesSelector)) && r(function(t) {
                b.disconnectedMatch = M.call(t, "div"),
                M.call(t, "[s!='']:x"),
                L.push("!=", ot)
            ...
            function(t, e) {
                ...
                return i ? i: (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === E || t.ownerDocument === N && I(N, t) ? -1 : e === E || e.ownerDocument === N && I(N, e) ? 1 : O ? tt(O, t) - tt(O, e) : 0 : 4 & i ? -1 : 1)
            }: function(t, e) {
                if (t === e) return A = !0,
                0;
                var i, n = 0,
        ...
        e.matchesSelector = function(t, i) {
            if ((t.ownerDocument || t) !== E && F(t), i = i.replace(ct, "='$1']"), b.matchesSelector && R && !V[i + " "] && (!L || !L.test(i)) && (!D || !D.test(i))) try {
                var n = M.call(t, i);
        ...
        e.contains = function(t, e) {
            return (t.ownerDocument || t) !== E && F(t),
            I(t, e)
        },
        e.attr = function(t, e) { (t.ownerDocument || t) !== E && F(t);
        ...
        e.uniqueSort = function(t) {
            ...
            n = 0,
            r = 0;
            if (A = !b.detectDuplicates, O = !b.sortStable && t.slice(0), t.sort(Y), A) {
        ...
        x = e.selectors = {
            ...
            filter: {
                ...
                CLASS: function(t) {
                    var e = B[t + " "];
                    return e || (e = new RegExp("(^|" + it + ")" + t + "(" + it + "|$)")) && B(t,
                    function(t) {
                ...
                CHILD: function(t, e, i, n, r) {
                    ...
                    function(t) {
                        ...
                        if (g) {
                            ...
                            } else if (y && (d = e, h = d[j] || (d[j] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], f = u[0] === q && u[1], _ = f), _ === !1) for (; (d = ++f && d && d[m] || (_ = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++_ || (y && (h = d[j] || (d[j] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[t] = [q, _]), d !== e)););
                            return _ -= r,
                            _ === n || _ % n === 0 && _ / n >= 0
                        }
                    }
                ...
                PSEUDO: function(t, i) {
                    ...
                    return o[j] ? o(i) : o.length > 1 ? (r = [t, t, "", i], x.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function(t, e) {
                        for (var n, r = o(t, i), s = r.length; s--;) n = tt(t, r[s]),
                        t[n] = !(e[n] = r[s])
                    }) : function(t) {
                        return o(t, 0, r)
                    }) : o
            ...
            pseudos: {
                ...
                lang: n(function(t) {
                    ...
                    function(e) {
                        var i;
                        do
                        if (i = R ? e.lang: e.getAttribute("xml:lang") || e.getAttribute("lang")) return i = i.toLowerCase(),
                        i === t || 0 === i.indexOf(t + "-");
        ...
        P = e.select = function(t, e, i, n) {
            ...
            if (i = i || [], 1 === h.length) {
                if (o = h[0] = h[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && b.getById && 9 === e.nodeType && R && x.relative[o[1].type]) {
                    if (e = (x.find.ID(s.matches[0].replace(wt, bt), e) || [])[0], !e) return i;
                    u && (e = e.parentNode),
                    t = t.slice(o.shift().value.length)
                }
                for (r = ft.needsContext.test(t) ? 0 : o.length; r--&&(s = o[r], !x.relative[a = s.type]);) if ((l = x.find[a]) && (n = l(s.matches[0].replace(wt, bt), yt.test(o[0].type) && c(e.parentNode) || e))) {
                    if (o.splice(r, 1), t = n.length && d(o), !t) return K.apply(i, n),
                    i;
                    break
                }
            }
            return (u || S(t, h))(n, e, !R, i, !e || yt.test(t) && c(e.parentNode) || e),
            i
        },
        b.sortStable = j.split("").sort(Y).join("") === j,
    ...
    ot.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? ot.find.matchesSelector(n, t) ? [n] : [] : ot.find.matches(t, ot.grep(e,
        function(t) {
            return 1 === t.nodeType
        }))
    },
    ...
    ot.fn.extend({
        ...
        closest: function(t, e) {
            for (var i, n = 0,
            r = this.length,
            o = [], s = ft.test(t) || "string" != typeof t ? ot(t, e || this.context) : 0; r > n; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (s ? s.index(i) > -1 : 1 === i.nodeType && ot.find.matchesSelector(i, t))) {
                o.push(i);
                break
            }
    ...
    function(t, e) {
        ot.fn[t] = function(i, n) {
            ...
            this.length > 1 && (wt[t] || ot.uniqueSort(r), _t.test(t) && r.reverse()),
            this.pushStack(r)
        }
    });
    var bt = /\S+/g;
    ot.Callbacks = function(t) {
        ...
        c = {
            add: function() {
                return s && (i && !e && (l = s.length - 1, a.push(i)),
                function n(e) {
                    ot.each(e,
                    function(e, i) {
            ...
            remove: function() {
                ...
                function(t, e) {
                    for (var i; (i = ot.inArray(e, s, i)) > -1;) s.splice(i, 1),
                    l >= i && l--
                }),
                this
            },
            ...
            fireWith: function(t, i) {
                return r || (i = i || [], i = [t, i.slice ? i.slice() : i], a.push(i), e || u()),
                this
            },
            fire: function() {
    ...
    ot.extend({
        ...
        when: function(t) {
            ...
            if (s > 1) for (e = new Array(s), i = new Array(s), n = new Array(s); s > r; r++) o[r] && ot.isFunction(o[r].promise) ? o[r].promise().progress(u(r, i, e)).done(u(r, n, o)).fail(l.reject) : --a;
    ...
    ot.extend({
        ...
        ready: function(t) { (t === !0 ? --ot.readyWait: ot.isReady) || (ot.isReady = !0, t !== !0 && --ot.readyWait > 0 || (xt.resolveWith(Q, [ot]), ot.fn.triggerHandler && (ot(Q).triggerHandler("ready"), ot(Q).off("ready"))))
        }
    }),
    ot.ready.promise = function(e) {
        return xt || (xt = ot.Deferred(), "complete" === Q.readyState || "loading" !== Q.readyState && !Q.documentElement.doScroll ? t.setTimeout(ot.ready) : (Q.addEventListener("DOMContentLoaded", s), t.addEventListener("load", s))),
        xt.promise(e)
    },
    ot.ready.promise();
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== o) {
                if (void 0 === e) this.register(t);
                    ...
                    ot.isArray(e) ? n = e.concat(e.map(ot.camelCase)) : (r = ot.camelCase(e), e in o ? n = [e, r] : (n = r, n = n in o ? [n] : n.match(bt) || [])),
                    i = n.length;
                    for (; i--;) delete o[n[i]]
        ...
        data: function(t, e) {
            ...
            function(e) {
                ...
                this.each(function() {
                    var i = St.get(this, n);
                    St.set(this, n, e),
                    t.indexOf("-") > -1 && void 0 !== i && St.set(this, t, e)
                })
            },
    ...
    ot.fn.extend({
        queue: function(t, e) {
            ...
            arguments.length < i ? ot.queue(this[0], t) : void 0 === e ? this: this.each(function() {
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;) i = kt.get(o[s], t + "queueHooks"),
    ...
    ot.event = {
        ...
        add: function(t, e, i, n, r) {
            ...
            }), e = (e || "").match(bt) || [""], u = e.length; u--;) a = Nt.exec(e[u]) || [],
            f = m = a[1],
            p = (a[2] || "").split(".").sort(),
            f && (h = ot.event.special[f] || {},
            f = (r ? h.delegateType: h.bindType) || f, h = ot.event.special[f] || {},
            c = ot.extend({
                type: f,
                origType: m,
                data: n,
        ...
        remove: function(t, e, i, n, r) {
            ...
            if (g && (l = g.events)) {
                for (e = (e || "").match(bt) || [""], u = e.length; u--;) if (a = Nt.exec(e[u]) || [], f = m = a[1], p = (a[2] || "").split(".").sort(), f) {
                    for (h = ot.event.special[f] || {},
                    f = (n ? h.delegateType: h.bindType) || f, d = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o],
                    !r && m !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, h.remove && h.remove.call(t, c));
        ...
        handlers: function(t, e) {
            ...
            if (a && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1)) for (; l !== this; l = l.parentNode || this) if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                for (n = [], i = 0; a > i; i++) o = e[i],
                r = o.selector + " ",
                void 0 === n[r] && (n[r] = o.needsContext ? ot(r, this).index(l) > -1 : ot.find(r, this, null, [l]).length),
                n[r] && n.push(o);
                n.length && s.push({
                    elem: l,
                    handlers: n
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || Q, n = i.documentElement, r = i.body, t.pageX = e.clientX + (n && n.scrollLeft || r && r.scrollLeft || 0) - (n && n.clientLeft || r && r.clientLeft || 0), t.pageY = e.clientY + (n && n.scrollTop || r && r.scrollTop || 0) - (n && n.clientTop || r && r.clientTop || 0)),
        ...
        fix: function(t) {
            ...
            o = t,
            s = this.fixHooks[r];
            for (s || (this.fixHooks[r] = s = jt.test(r) ? this.mouseHooks: It.test(r) ? this.keyHooks: {}), n = s.props ? this.props.concat(s.props) : this.props, t = new ot.Event(o), e = n.length; e--;) i = n[e],
            t[i] = o[i];
    ...
    function(t, e) {
        ot.event.special[t] = {
            ...
            handle: function(t) {
                ...
                r = t.relatedTarget,
                o = t.handleObj;
                return r && (r === n || ot.contains(n, r)) || (t.type = o.origType, i = o.handler.apply(this, arguments), t.type = e),
                i
            }
        }
    }),
    ...
    ot.extend({
        ...
        clone: function(t, e, i) {
            ...
            if (! (nt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t))) for (s = c(a), o = c(t), n = 0, r = o.length; r > n; n++) b(o[n], s[n]);
            if (e) if (i) for (o = o || c(t), s = s || c(a), n = 0, r = o.length; r > n; n++) w(o[n], s[n]);
            else w(t, a);
            return s = c(a, "script"),
            s.length > 0 && h(s, !l && c(t, "script")),
            a
        },
        cleanData: function(t) {
            for (var e, i, n, r = ot.event.special,
            o = 0; void 0 !== (i = t[o]); o++) if (Ct(i)) {
                if (e = i[kt.expando]) {
        ...
        html: function(t) {
            ...
            function(t) {
                ...
                if ("string" == typeof t && !Ht.test(t) && !Lt[(Rt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n > i; i++) e = this[i] || {},
                        1 === e.nodeType && (ot.cleanData(c(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch(r) {}
                }
    ...
    function(t, e) {
        ot.fn[t] = function(t) {
            for (var i, n = [], r = ot(t), o = r.length - 1, s = 0; o >= s; s++) i = s === o ? this: this.clone(!0),
            ot(r[s])[e](i),
            K.apply(n, i.get());
    ...
    ot.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                l = t.style;
                return e = ot.cssProps[a] || (ot.cssProps[a] = $(a) || a),
                s = ot.cssHooks[e] || ot.cssHooks[a],
                void 0 === i ? s && "get" in s && void 0 !== (r = s.get(t, !1, n)) ? r: l[e] : (o = typeof i, "string" === o && (r = At.exec(i)) && r[1] && (i = u(t, e, r), o = "number"), null != i && i === i && ("number" === o && (i += r && r[3] || (ot.cssNumber[a] ? "": "px")), nt.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (i = s.set(t, i, n)) || (l[e] = i)), void 0)
            }
        },
    ...
    function(t, e) {
        ot.cssHooks[e] = {
            get: function(t, i, n) {
                return i ? Jt.test(ot.css(t, "display")) && 0 === t.offsetWidth ? Zt(t, te,
                function() {
                    return F(t, e, n)
                }) : F(t, e, n) : void 0
            },
            set: function(t, i, n) {
                ...
                return s && (r = At.exec(i)) && "px" !== (r[3] || "px") && (t.style[e] = i, i = ot.css(t, e)),
                O(t, i, s)
            }
        }
    }),
    ot.cssHooks.marginLeft = P(nt.reliableMarginLeft,
    function(t, e) {
    ...
    ot.cssHooks.marginRight = P(nt.reliableMarginRight,
    function(t, e) {
        return e ? Zt(t, {
    ...
    function(t, e) {
        ot.cssHooks[t + e] = {
            expand: function(i) {
                for (var n = 0,
                r = {},
                o = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) r[t + Ft[n] + e] = o[n] || o[n - 2] || o[0];
                return r
            }
        },
    ...
    ot.fn.extend({
        ...
        animate: function(t, e, i, n) {
            ...
            o = ot.speed(e, i, n),
            s = function() {
                var e = j(this, ot.extend({},
                t), o); (r || kt.get(this, "finish")) && e.stop(!0)
            };
            return s.finish = s,
        ...
        stop: function(t, e, i) {
            ...
            this.each(function() {
                ...
                for (r = o.length; r--;) o[r].elem !== this || null != t && o[r].queue !== t || (o[r].anim.stop(i), e = !1, o.splice(r, 1)); ! e && i || ot.dequeue(this, t)
            })
        },
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
    ...
    ot.fx.tick = function() {
        var t, e = 0,
        i = ot.timers;
        for (re = ot.now(); e < i.length; e++) t = i[e],
    ...
    ot.extend({
        ...
        removeAttr: function(t, e) {
            var i, n, r = 0,
            o = e && e.match(bt);
            if (o && 1 === t.nodeType) for (; i = o[r++];) n = ot.propFix[i] || i,
    ...
    le = {
        set: function(t, e, i) {
            return e === !1 ? ot.removeAttr(t, i) : t.setAttribute(i, i),
            i
        }
    },
    ...
    function(t, e) {
        ...
        ue[e] = function(t, e, n) {
            var r, o;
            return n || (o = ue[e], ue[e] = r, r = null != i(t, e, n) ? e.toLowerCase() : null, ue[e] = o),
            r
        }
    });
    ...
    ot.extend({
        prop: function(t, e, i) {
            var n, r, o = t.nodeType;
            if (3 !== o && 8 !== o && 2 !== o) return 1 === o && ot.isXMLDoc(t) || (e = ot.propFix[e] || e, r = ot.propHooks[e]),
    ...
    ot.fn.extend({
        addClass: function(t) {
            ...
            if ("string" == typeof t && t) for (e = t.match(bt) || []; i = this[l++];) if (r = N(i), n = 1 === i.nodeType && (" " + r + " ").replace(de, " ")) {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function(i) {
                ...
                var e, n, r, o;
                if ("string" === i) for (n = 0, r = ot(this), o = t.match(bt) || []; e = o[n++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
        ...
        val: function(t) {
            var e, i, n, r = this[0]; {
                ...
                this.each(function(i) {
                    var r;
                    1 === this.nodeType && (r = n ? t.call(this, i, ot(this).val()) : t, null == r ? r = "": "number" == typeof r ? r += "": ot.isArray(r) && (r = ot.map(r,
                    function(t) {
                        return null == t ? "": t + ""
                    })), e = ot.valHooks[this.type] || ot.valHooks[this.nodeName.toLowerCase()], e && "set" in e && void 0 !== e.set(this, r, "value") || (this.value = r))
                });
                if (r) return e = ot.valHooks[r.type] || ot.valHooks[r.nodeName.toLowerCase()],
                e && "get" in e && void 0 !== (i = e.get(r, "value")) ? i: (i = r.value, "string" == typeof i ? i.replace(fe, "") : null == i ? "": i)
            }
        }
    }),
    ot.extend({
        valHooks: {
            ...
            select: {
                get: function(t) {
                    ...
                    s = o ? null: [], a = o ? r + 1 : n.length, l = 0 > r ? a: o ? r: 0; a > l; l++) if (i = n[l], (i.selected || l === r) && (nt.optDisabled ? !i.disabled: null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !ot.nodeName(i.parentNode, "optgroup"))) {
                ...
                set: function(t, e) {
                    ...
                    o = ot.makeArray(e), s = r.length; s--;) n = r[s],
                    (n.selected = ot.inArray(ot.valHooks.option.get(n), o) > -1) && (i = !0);
    ...
    ot.extend(ot.event, {
        trigger: function(e, i, n, r) {
            ...
            if (s = a = n = n || Q, 3 !== n.nodeType && 8 !== n.nodeType && !me.test(f + ot.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), u = f.indexOf(":") < 0 && "on" + f, e = e[ot.expando] ? e: new ot.Event(f, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ot.makeArray(i, [e]), h = ot.event.special[f] || {},
            r || !h.trigger || h.trigger.apply(n, i) !== !1)) {
                if (!r && !h.noBubble && !ot.isWindow(n)) {
                    for (l = h.delegateType || f, me.test(l + f) || (s = s.parentNode); s; s = s.parentNode) d.push(s),
                    a = s;
                    a === (n.ownerDocument || Q) && d.push(a.defaultView || a.parentWindow || t)
                }
                for (o = 0; (s = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l: h.bindType || f,
                c = (kt.get(s, "events") || {})[e.type] && kt.get(s, "handle"),
                c && c.apply(s, i),
                c = u && s[u],
                c && c.apply && Ct(s) && (e.result = c.apply(s, i), e.result === !1 && e.preventDefault());
                return e.type = f,
                r || e.isDefaultPrevented() || h._default && h._default.apply(d.pop(), i) !== !1 || !Ct(n) || u && ot.isFunction(n[f]) && !ot.isWindow(n) && (a = n[u], a && (n[u] = null), ot.event.triggered = f, n[f](), ot.event.triggered = void 0, a && (n[u] = a)),
                e.result
            }
        },
    ...
    ot.parseXML = function(e) {
        ...
        return i && !i.getElementsByTagName("parsererror").length || ot.error("Invalid XML: " + e),
        i
    };
    var _e = /#.*$/,
    we = /([?&])_=[^&]*/,
    ...
    ot.extend({
        ...
        ajax: function(e, i) {
            function n(e, i, n, a) {
                var u, h, y, _, b, T = i;
                2 !== w && (w = 2, l && t.clearTimeout(l), r = void 0, s = a || "", x.readyState = e > 0 ? 4 : 0, u = e >= 200 && 300 > e || 304 === e, n && (_ = W(d, x, n)), _ = V(d, _, x, u), u ? (d.ifModified && (b = x.getResponseHeader("Last-Modified"), b && (ot.lastModified[o] = b), b = x.getResponseHeader("etag"), b && (ot.etag[o] = b)), 204 === e || "HEAD" === d.type ? T = "nocontent": 304 === e ? T = "notmodified": (T = _.state, h = _.data, y = _.error, u = !y)) : (y = T, !e && T || (T = "error", 0 > e && (e = 0))), x.status = e, x.statusText = (i || T) + "", u ? m.resolveWith(f, [h, T, x]) : m.rejectWith(f, [x, T, y]), x.statusCode(v), v = void 0, c && p.trigger(u ? "ajaxSuccess": "ajaxError", [x, d, u ? h: y]), g.fireWith(f, [x, T]), c && (p.trigger("ajaxComplete", [x, d]), --ot.active || ot.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (i = e, e = void 0),
            i = i || {};
            var r, o, s, a, l, u, c, h, d = ot.ajaxSetup({},
            i),
            f = d.context || d,
            ...
            x = {
                ...
                getResponseHeader: function(t) {
                    var e;
                    if (2 === w) {
                        if (!a) for (a = {}; e = be.exec(s);) a[e[1].toLowerCase()] = e[2];
                        e = a[t.toLowerCase()]
                    }
            ...
            if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || ge.href) + "").replace(_e, "").replace(Ce, ge.protocol + "//"), d.type = i.method || i.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain) {
                u = Q.createElement("a");
                try {
                    u.href = d.url,
                    u.href = u.href,
                    d.crossDomain = $e.protocol + "//" + $e.host != u.protocol + "//" + u.host
                } catch(T) {
                    d.crossDomain = !0
                }
            }
            if (d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), H(ke, d, i, x), 2 === w) return x;
            c = ot.event && d.global,
            c && 0 === ot.active++&&ot.event.trigger("ajaxStart"),
            d.type = d.type.toUpperCase(),
            d.hasContent = !Te.test(d.type),
            o = d.url,
            d.hasContent || (d.data && (o = d.url += (ye.test(o) ? "&": "?") + d.data, delete d.data), d.cache === !1 && (d.url = we.test(o) ? o.replace(we, "$1_=" + ve++) : o + (ye.test(o) ? "&": "?") + "_=" + ve++)),
            d.ifModified && (ot.lastModified[o] && x.setRequestHeader("If-Modified-Since", ot.lastModified[o]), ot.etag[o] && x.setRequestHeader("If-None-Match", ot.etag[o])),
            ...
            if (r = H(Se, d, i, x)) {
                if (x.readyState = 1, c && p.trigger("ajaxSend", [x, d]), 2 === w) return x;
    ...
    function(t, e) {
        ot[e] = function(t, i, n, r) {
            return ot.isFunction(i) && (r = r || n, n = i, i = void 0),
            ot.ajax(ot.extend({
                url: t,
                type: e,
                dataType: r,
    ...
    ot.param = function(t, e) {
        ...
        if (void 0 === e && (e = ot.ajaxSettings && ot.ajaxSettings.traditional), ot.isArray(t) || t.jquery && !ot.isPlainObject(t)) ot.each(t,
        function() {
    ...
    ot.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var i = ot(this).val();
                return null == i ? null: ot.isArray(i) ? ot.map(i,
                function(t) {
                    return {
                        name: e.name,
                        value: t.replace(Fe, "\r\n")
    ...
    nt.cors = !!De && "withCredentials" in De,
    nt.ajax = De = !!De,
    ...
    function(e, i, n) {
        ...
        return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Me, "$1" + r) : e.jsonp !== !1 && (e.url += (ye.test(e.url) ? "&": "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
        ...
        n.always(function() {
            ...
            e[r] && (e.jsonpCallback = i.jsonpCallback, Le.push(r)),
    ...
    ot.offset = {
        setOffset: function(t, e, i) {
            ...
            u ? (n = h.position(), s = n.top, r = n.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0),
            ot.isFunction(e) && (e = e.call(t, i, ot.extend({},
            a))),
    ...
    ot.fn.extend({
        offset: function(t) {
            ...
            ot.contains(e, n) ? (r = n.getBoundingClientRect(), i = X(o), {
    ...
    ot.each(["top", "left"],
    function(t, e) {
        ot.cssHooks[e] = P(nt.pixelPosition,
        function(t, i) {
            return i ? (i = S(t, e), Qt.test(i) ? ot(t).position()[e] + "px": i) : void 0
        })
    }),
    ot.each({
        Height: "height",
...
window.whatInput = function() {
    ...
    function r(t) {
        ...
        if ("pointer" === i && (i = l(t)), g !== i) {
            ...
            c = "input" === r ? n.getAttribute("type") : null; ! f.hasAttribute("data-whatinput-formtyping") && g && "keyboard" === i && "tab" !== T[e] && ("textarea" === r || "select" === r || "input" === r && v.indexOf(c) < 0) || _.indexOf(e) > -1 || o(i)
        }
        "keyboard" === i && u(e)
    }
    function o(t) {
        g = t,
        f.setAttribute("data-whatinput", g),
        -1 === x.indexOf(g) && x.push(g)
    }
    function s(t) {
    ...
    function u(t) { - 1 === p.indexOf(T[t]) && T[t] && p.push(T[t])
    }
    function c(t) {
        var e = s(t),
        i = p.indexOf(T[e]); - 1 !== i && p.splice(i, 1)
    }
    function h() {
        f = document.body,
        window.PointerEvent ? (f.addEventListener("pointerdown", e), f.addEventListener("pointermove", e)) : window.MSPointerEvent ? (f.addEventListener("MSPointerDown", e), f.addEventListener("MSPointerMove", e)) : (f.addEventListener("mousedown", e), f.addEventListener("mousemove", e), "ontouchstart" in window && f.addEventListener("touchstart", t)),
        f.addEventListener(y, e),
...
function(t) {
    ...
    var s = function(i) {
        ...
        s = t(".no-js");
        if (r.length || t('<meta class="foundation-mq">').appendTo(document.head), s.length && s.removeClass("no-js"), "undefined" === n) o.MediaQuery._init(),
        o.reflow(this);
        else {
...
function(t) {
    ...
    function n(t, e, n, r, o, s) {
        ...
        case "center bottom":
            return {
                left:
                s ? o: l.offset.left + l.width / 2 - a.width / 2,
...
function(t) {
    ...
    r = {
        ...
        handleKey: function(e, i, r) {
            ...
            l.rtl, l.ltr), s = o[u], a = r[s], a && "function" == typeof a) {
                var c = a.apply(); (r.handled || "function" == typeof r.handled) && r.handled(c)
...
function(t) {
    function e(t) {
        ...
        return "string" != typeof t ? e: (t = t.trim().slice(1, -1)) ? e = t.split("&").reduce(function(t, e) {
            ...
            t.hasOwnProperty(n) ? Array.isArray(t[n]) ? t[n].push(r) : t[n] = [t[n], r] : t[n] = r,
            t
        },
        {}) : e
    }
    var i = {
        ...
        _watcher: function() {
            var e = this;
            t(window).on("resize.zf.mediaquery",
            function() {
...
function(t) {
    function e(t, e, i) {
        function n(a) {
            ...
            o = a - s,
            i.apply(e),
            t > o ? r = window.requestAnimationFrame(n, e) : (window.cancelAnimationFrame(r), e.trigger("finished.zf.animate", [e]).triggerHandler("finished.zf.animate", [e]))
        }
        var r, o, s = null;
...
function(t) {
    var e = {
        ...
        Burn: function(t, e) {
            ...
            t.find("*").removeClass(i + " " + n + " " + r + " is-submenu-item submenu is-active").removeAttr("data-submenu").css("display", "")
        }
    };
    Foundation.Nest = e
} (jQuery),
...
function(t) {
    ...
    function i(e, i) {
        ...
        0 === r && i(),
        e.each(function() {
            this.complete ? n() : "undefined" != typeof this.naturalWidth && this.naturalWidth > 0 ? n() : t(this).one("load",
            function() {
                n()
            })
        })
...
function(t) {
    ...
    function i(i) {
        if (t.spotSwipe.preventDefault && i.preventDefault(), u) {
            ...
            Math.abs(s) >= t.spotSwipe.moveThreshold && l <= t.spotSwipe.timeThreshold && (n = s > 0 ? "left": "right"),
...
function(t) {
    t.fn.addTouch = function() {
        this.each(function(i, n) {
            t(n).bind("touchstart touchmove touchend touchcancel",
            function() {
                e(event)
            })
        });
...
function(t) {
    ...
    function n(e) {
        var i = void 0,
        n = t("[data-resize]");
        n.length && t(window).off("resize.zf.trigger").on("resize.zf.trigger",
        function(r) {
            i && clearTimeout(i),
    ...
    function r(e) {
        var i = void 0,
        n = t("[data-scroll]");
        n.length && t(window).off("scroll.zf.trigger").on("scroll.zf.trigger",
        function(r) {
            i && clearTimeout(i),
            i = setTimeout(function() {
                s || n.each(function() {
    ...
    t(document).on("click.zf.trigger", "[data-open]",
    function() {
        a(t(this), "open")
    }),
    t(document).on("click.zf.trigger", "[data-close]",
    function() {
        var e = t(this).data("close");
        e ? a(t(this), "close") : t(this).trigger("close.zf.trigger")
    }),
    t(document).on("click.zf.trigger", "[data-toggle]",
    function() {
        a(t(this), "toggle")
    }),
    t(document).on("close.zf.trigger", "[data-closable]",
    function(e) {
        e.stopPropagation();
        var i = t(this).data("closable");
        "" !== i ? Foundation.Motion.animateOut(t(this), i,
        function() {
            t(this).trigger("closed.zf")
        }) : t(this).fadeOut().trigger("closed.zf")
    }),
    t(document).on("focus.zf.trigger blur.zf.trigger", "[data-toggle-focus]",
    function() {
    ...
    var e = function() {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                r && (n = this.matchValidation(t, r, t.attr("required"))),
                t.attr("data-equalto") && (o = this.options.validators.equalTo(t));
                var s = -1 === [e, i, n, o].indexOf(!1),
    ...
    var e = function() {
        ...
        },
        {
            ...
            value: function(e) {
                ...
                n = this,
                r = this.options.multiExpand ? i.hasClass("is-active") : e.parent().hasClass("is-active"); (this.options.allowAllClosed || r) && (e.slideUp(n.options.slideSpeed,
                function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.$element.find("li").each(function() {
                    ...
                    i.length && t(this).children("a").off("click.zf.accordionMenu").on("click.zf.accordionMenu",
                    function(t) {
                        t.preventDefault(),
                        e.toggle(i)
                    })
                ...
                function(i) {
                    ...
                    Foundation.Keyboard.handleKey(i, "AccordionMenu", {
                        ...
                        down: function() {
                            return r.attr("tabindex", -1).focus(),
                            !0
                        },
                        toggle: function() {
    ...
    var e = function() {
            ...
            value: function(e) {
                ...
                function(n) {
                    if (t(n.target).parentsUntil("ul", "li").hasClass("is-drilldown-submenu-parent") && (n.stopImmediatePropagation(), n.preventDefault()), i._show(e.parent("li")), i.options.closeOnClick) {
                        var r = t("body");
                        r.off(".zf.drilldown").on("click.zf.drilldown",
                        function(e) {
        ...
        },
        {
            ...
            value: function() {
                ...
                function(i) {
                    ...
                    s.each(function(e) {
                        return t(this).is(o) ? (n = s.eq(Math.max(0, e - 1)), void(r = s.eq(Math.min(e + 1, s.length - 1)))) : void 0
                    }),
                    Foundation.Keyboard.handleKey(i, "Drilldown", {
                        next: function() {
                            return o.is(e.$submenuAnchors) ? (e._show(o.parent("li")), o.parent("li").one(Foundation.transitionend(o),
                            function() {
                        ...
                        open: function() {
                            return o.is(e.$menuItems) ? o.is(e.$submenuAnchors) && (e._show(o.parent("li")), o.parent("li").one(Foundation.transitionend(o),
                            function() {
                                o.parent("li").find("ul li a").filter(e.$menuItems).first().focus()
                            })) : (e._hide(o.parent("li").parent("ul")), o.parent("li").parent("ul").one(Foundation.transitionend(o),
                            function() {
                                setTimeout(function() {
                                    o.parent("li").parent("ul").parent("li").children("a").first().focus()
                                },
        ...
        },
        {
            ...
            value: function() {
                ...
                t.one(Foundation.transitionend(t),
                function(e) {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                t.children(".js-drilldown-back").on("click.zf.drilldown",
                function(i) {
                    i.stopImmediatePropagation(),
                    e._hide(t)
                })
        ...
        },
        {
            key: "_hide",
            value: function(t) {
                t.addClass("is-closing").one(Foundation.transitionend(t),
                function() {
                    t.removeClass("is-active is-closing"),
                    t.blur()
                }),
    ...
    var e = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.classChanged = !0,
                !1;
                for (this.$element.offset(Foundation.Box.GetOffsets(this.$element, this.$anchor, t, this.options.vOffset, this.options.hOffset)); ! Foundation.Box.ImNotTouchingYou(this.$element, !1, !0) && this.counter;) this._reposition(t),
                this._setPosition()
            }
        },
        {
            ...
            value: function() {
                ...
                function(i) {
                    ...
                    Foundation.Keyboard.handleKey(i, "Dropdown", {
                        ...
                        tab_backward: function() { (e.$element.find(":focus").is(r.eq(0)) || e.$element.is(":focus")) && (e.options.trapFocus ? (r.eq( - 1).focus(), i.preventDefault()) : e.close())
                        },
                        open: function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                i = this;
                e.off("click.zf.dropdown").on("click.zf.dropdown",
                function(t) {
    ...
    var e = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                }; (this.options.clickOpen || i) && this.$menuItems.on("click.zf.dropdownmenu touchstart.zf.dropdownmenu", r),
                ...
                function(i) {
                    ...
                    a.each(function(e) {
                        return t(this).is(o) ? (n = a.eq(e - 1), void(r = a.eq(e + 1))) : void 0
                    });
                    var l = function() {
                    ...
                    s ? e.$element.hasClass(e.options.verticalClass) ? "left" === e.options.alignment ? t.extend(d, {
                        down: l,
                        up: u,
                        next: c,
                        previous: h
                        ...
                        down: c,
                        up: h
                    }) : "left" === e.options.alignment ? t.extend(d, {
                        next: c,
                        previous: h,
                        down: l,
                        up: u
        ...
        },
        {
            ...
            value: function() {
                ...
                i = this;
                e.off("mouseup.zf.dropdownmenu touchend.zf.dropdownmenu").on("mouseup.zf.dropdownmenu touchend.zf.dropdownmenu",
                function(t) {
        ...
        },
        {
            ...
            value: function(e) {
                ...
                if (!r) {
                    ...
                    r = Foundation.Box.ImNotTouchingYou(e, null, !0),
                    r || s.removeClass("opens-" + this.options.alignment).addClass("opens-inner"),
                    this.changed = !0
                }
                e.css("visibility", ""),
                this.options.closeOnClick && this._addBodyHandler(),
            ...
            value: function(t, e) {
                ...
                if (n) {
                    if (i.find("li.is-active").add(i).attr({
                        ...
                        i.find("li.is-dropdown-submenu-parent").add(i).removeClass("opens-inner opens-" + this.options.alignment).addClass("opens-" + r),
                        this.changed = !1
                    }
    ...
    var e = function() {
        ...
        return _createClass(e, [{
            ...
            value: function() {
                ...
                (void 0 !== n && n === !1 || void 0 === n) && (r.length ? Foundation.onImagesLoaded(r, this._reflow.bind(this)) : this._reflow())
            }
        },
        {
            key: "_pauseEvents",
        ...
        },
        {
            key: "getHeights",
            value: function(t) {
                for (var e = [], i = 0, n = this.$watched.length; n > i; i++) this.$watched[i].style.height = "auto",
        ...
        },
        {
            ...
            value: function(e) {
                ...
                n[r] = [];
                for (var o = 0,
                s = this.$watched.length; s > o; o++) {
                    this.$watched[o].style.height = "auto";
                    var a = t(this.$watched[o]).offset().top;
                    a != i && (r++, n[r] = [], i = a),
                    n[r].push([this.$watched[o], this.$watched[o].offsetHeight])
                }
                for (var l = 0,
                u = n.length; u > l; l++) {
        ...
        },
        {
            ...
            value: function(e) {
                ...
                n = e.length; n > i; i++) {
                    var r = e[i].length,
                    o = e[i][r - 1];
                    if (2 >= r) t(e[i][0][0]).css({
                        height: "auto"
                    });
                    else {
                        this.$element.trigger("preequalizedrow.zf.equalizer");
                        for (var s = 0,
                        a = r - 1; a > s; s++) t(e[i][s][0]).css({
                            height: o
                        });
    ...
    var e = function() {
        ...
        },
        {
            ...
            value: function(t, e, i) {
                ...
                l = t ? "Left": "Right",
                u = this;
                r = e ? e: t ? this.options.infiniteWrap ? n.next("." + this.options.slideClass).length ? n.next("." + this.options.slideClass) : o: n.next("." + this.options.slideClass) : this.options.infiniteWrap ? n.prev("." + this.options.slideClass).length ? n.prev("." + this.options.slideClass) : s: n.prev("." + this.options.slideClass),
                r.length && (this.options.bullets && (i = i || this.$slides.index(r), this._updateBullets(i)), this.options.useMUI ? (Foundation.Motion.animateIn(r.addClass("is-active").css({
                    position: "absolute",
                    top: 0
...
function(t) {
    var e = function() {
        ...
        return _createClass(e, [{
            ...
            value: function() {
                if ("string" == typeof this.rules) {
                    for (var e = {},
                    n = this.rules.split(" "), r = 0; r < n.length; r++) {
                        var o = n[r].split("-"),
        ...
        },
        {
            ...
            value: function() {
                var e = this;
                t(window).on("changed.zf.mediaquery",
                function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                e && (this.currentPlugin instanceof this.rules[e].plugin || (t.each(i,
                function(t, e) {
    ...
    var r = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                s = t(window).height();
                e = "auto" === this.options.hOffset ? parseInt((r - n) / 2, 10) : parseInt(this.options.hOffset, 10),
            ...
            value: function() {
                ...
                this.$element.on({
                    ...
                    "close.zf.trigger": function(n, r) {
                        return n.target === i.$element[0] || t(n.target).parents("[data-closable]")[0] === r ? e.close.apply(e) : void 0
                    },
                    "toggle.zf.trigger": this.toggle.bind(this),
            ...
            value: function() {
                ...
                if (this.isActive = !0, this.$element.css({
                    ...
                    function() {
                        ...
                        Foundation.Motion.animateIn(e.$element, e.options.animationIn,
                        function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.options.overlay || !this.options.closeOnClick || this.options.fullScreen || t("body").on("click.zf.reveal",
                function(i) {
                    i.target === e.$element[0] || t.contains(e.$element[0], i.target) || e.close()
                }),
                this.options.closeOnEsc && t(window).on("keydown.zf.reveal",
                function(t) {
...
function(t) {
    ...
    var n = function() {
        function n(e, i) {
            ...
            this.$element = e,
            this.options = t.extend({},
            n.defaults, this.$element.data(), i),
            this._init(),
        ...
        return _createClass(n, [{
            ...
            value: function() {
                ...
                this.handles[1] && (this.options.doubleSided = !0, this.$handle2 = this.handles.eq(1), this.$input2 = this.inputs.length > 1 ? this.inputs.eq(1) : t("#" + this.$handle2.attr("aria-controls")), this.inputs[1] || (this.inputs = this.inputs.add(this.$input2)), e = !0, this._setHandlePos(this.$handle, this.options.initialStart, !0,
                function() {
                ...
                if (!this.$element.hasClass(this.options.disabledClass)) {
                    ...
                    if (this._setValues(t, i), o) {
                        ...
                        r && "function" == typeof r && r();
                            ...
                            y = g - (isNaN(b) ? this.options.initialStart / ((this.options.end - this.options.start) / 100) : b) + w
                        }
                        v["min-" + c] = y + "%"
                    }
                    ...
                    function() {
                        t.css(h, g + "%"),
                        l.options.doubleSided ? l.$fill.css(v) : l.$fill.css(c, 100 * p + "%")
                    }),
        ...
        },
        {
            ...
            value: function(n, r, o) {
                ...
                a = !0;
                    ...
                    var g, v = d - m;
                    if (g = 0 > v ? 0 : v > f ? f: v, offsetPct = e(g, f), s = (this.options.end - this.options.start) * offsetPct + this.options.start, Foundation.rtl() && !this.options.vertical && (s = this.options.end - s), s = l._adjustValue(null, s), a = !1, !r) {
                        var y = i(this.$handle, h, g, c),
                        _ = i(this.$handle2, h, g, c);
                        r = _ >= y ? this.$handle: this.$handle2
                    }
                }
        ...
        },
        {
            ...
            value: function(e) {
                ...
                e.off("keydown.zf.slider").on("keydown.zf.slider",
                function(e) {
                    var i, r = t(this),
...
function(t) {
    ...
    var i = function() {
        ...
        },
        {
            key: "_parsePoints",
            value: function() {
                for (var e = "" == this.options.topAnchor ? 1 : this.options.topAnchor, i = "" == this.options.btmAnchor ? document.documentElement.scrollHeight: this.options.btmAnchor, n = [e, i], r = {},
                o = 0, s = n.length; s > o && n[o]; o++) {
                    var a;
                    if ("number" == typeof n[o]) a = n[o];
                        ...
                        u = t("#" + l[0]);
                        a = u.offset().top,
                        l[1] && "bottom" === l[1].toLowerCase() && (a += u[0].getBoundingClientRect().height)
                    }
                    r[o] = a
                }
                this.points = r
        ...
        },
        {
            ...
            value: function(e) {
                ...
                this.isOn || (this.canStick && (this.isOn = !0, t(window).off(n).on(n,
                function(t) {
        ...
        },
        {
            ...
            value: function(t, e) {
                ...
                this.canStick ? (e || (e = window.pageYOffset), void(e >= this.topPoint ? e <= this.bottomPoint ? this.isStuck || this._setSticky() : this.isStuck && this._removeSticky(!1) : this.isStuck && this._removeSticky(!0))) : (this.isStuck && this._removeSticky(!0), !1)
            }
        },
        {
            key: "_setSticky",
            value: function() {
                ...
                n = "top" === e ? "bottom": "top",
                r = {};
                r[i] = this.options[i] + "em",
                r[e] = 0,
                r[n] = "auto",
                r.left = this.$container.offset().left + parseInt(window.getComputedStyle(this.$container[0])["padding-left"], 10),
                this.isStuck = !0,
                this.$element.removeClass("is-anchored is-at-" + n).addClass("is-stuck is-at-" + e).css(r).trigger("sticky.zf.stuckto:" + e),
        ...
        },
        {
            ...
            value: function(t) {
                ...
                n.left = "",
                this.isStuck = !1,
                this.$element.removeClass("is-stuck is-at-" + e).addClass("is-anchored is-at-" + s).css(n).trigger("sticky.zf.unstuckfrom:" + s)
            }
        },
        {
            key: "_setSizes",
        ...
        },
        {
            ...
            value: function(t, i) {
                ...
                "top" === this.options.stickTo ? (o -= n, s -= t + n) : "bottom" === this.options.stickTo && (o -= a - (t + r), s -= a - r),
                this.topPoint = o,
                this.bottomPoint = s,
                i && i()
            }
            ...
            value: function() {
                ...
                function(i) {
                    if (9 !== i.which) {
                        ...
                        s = o.parent("ul").children("li");
                        s.each(function(i) {
                            return t(this).is(o) ? void(e.options.wrapOnKeys ? (n = 0 === i ? s.last() : s.eq(i - 1), r = i === s.length - 1 ? s.first() : s.eq(i + 1)) : (n = s.eq(Math.max(0, i - 1)), r = s.eq(Math.min(i + 1, s.length - 1)))) : void 0
                        }),
    ...
    var e = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                function(i) {
                    return e = !0,
                    t.isClick ? (t.options.clickOpen || (e = !1), !1) : void t.show()
...
function() {
    function t(t) {
        ...
        return function(i, n, r, o) {
            ...
            a = (s || i).length,
            l = t > 0 ? 0 : a - 1;
            return arguments.length < 3 && (r = i[s ? s[l] : l], l += t),
            e(i, n, r, s, l, a)
        }
    }
    function e(t) {
    ...
    function i(t, e, i) {
        return function(n, r, o) {
            ...
            else if (i && o && a) return o = i(n, r),
            n[o] === r ? o: -1;
            if (r !== r) return o = e(c.call(n, s, a), y.isNaN),
            o >= 0 ? o + s: -1;
    ...
    function n(t, e) {
        ...
        o = "constructor";
        for (y.has(t, o) && !y.contains(e, o) && e.push(o); i--;) o = F[i],
    ...
    y.find = y.detect = function(t, e, i) {
        var n;
        return n = S(t) ? y.findIndex(t, e, i) : y.findKey(t, e, i),
    ...
    y.shuffle = function(t) {
        for (var e, i = S(t) ? t: y.values(t), n = i.length, r = Array(n), o = 0; n > o; o++) e = y.random(0, o),
        e !== o && (r[o] = r[e]),
        r[e] = i[o];
        return r
    },
    ...
    y.partition = function(t, e, i) {
        ...
        r = [];
        return y.each(t,
        function(t, i, o) { (e(t, i, o) ? n: r).push(t)
        }),
        [n, r]
    },
    ...
    y.object = function(t, e) {
        for (var i = {},
        n = 0,
        r = k(t); r > n; n++) e ? i[t[n]] = e[n] : i[t[n][0]] = t[n][1];
        return i
    },
    y.findIndex = e(1),
    y.findLastIndex = e( - 1),
    ...
    y.partial = function(t) {
        ...
        i = function() {
            for (var n = 0,
            r = e.length,
            o = Array(r), s = 0; r > s; s++) o[s] = e[s] === y ? arguments[n++] : e[s];
    ...
    y.throttle = function(t, e, i) {
        ...
        return function() {
            ...
            return n = this,
            r = arguments,
            0 >= c || c > e ? (s && (clearTimeout(s), s = null), a = u, o = t.apply(n, r), s || (n = r = null)) : s || i.trailing === !1 || (s = setTimeout(l, c)),
            o
        }
    },
    ...
    y.compose = function() {
        ...
        return function() {
            for (var i = e,
            n = t[e].apply(this, arguments); i--;) n = t[i].call(this, n);
            return n
        }
    },
    ...
    y.mapObject = function(t, e, i) {
        e = w(e, i);
        for (var n, r = y.keys(t), o = r.length, s = {},
        a = 0; o > a; a++) n = r[a],
        s[n] = e(t[n], n, t);
        return s
    },
    ...
    y.invert = function(t) {
        for (var e = {},
        i = y.keys(t), n = 0, r = i.length; r > n; n++) e[t[i[n]]] = i[n];
        return e
    },
    ...
    y.template = function(t, e, i) { ! e && i && (e = i),
        e = y.defaults({},
        ...
        t.replace(n,
        function(e, i, n, s, a) {
            return o += t.slice(r, a).replace(j, N),
            r = a + e.length,
...
function(t) {
    ...
    if (!t.jQuery) {
        ...
        i.extend = function() {
            ...
            u = arguments.length,
            c = !1;
            for ("boolean" == typeof a && (c = a, a = arguments[l] || {},
            l++), "object" != typeof a && "function" !== i.type(a) && (a = {}), l === u && (a = this, l--); u > l; l++) if (null != (o = arguments[l])) for (r in o) t = a[r],
            n = o[r],
            a !== n && (c && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, s = t && i.isArray(t) ? t: []) : s = t && i.isPlainObject(t) ? t: {},
            a[r] = i.extend(c, s, n)) : void 0 !== n && (a[r] = n));
            return a
        },
        ...
        i.dequeue = function(t, e) {
            ...
            function(t, n) {
                ...
                o && ("fx" === e && r.unshift("inprogress"), o.call(n,
                function() {
                    i.dequeue(n, e)
                }))
            })
        ...
        o = r.hasOwnProperty,
        s = r.toString,
        a = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < a.length; l++) r["[object " + a[l] + "]"] = a[l].toLowerCase();
...
function(t) {
    ...
    return function(t, e, i, n) {
        ...
        function l(t, i, n, r) {
            ...
            function h() {
                for (var e = 0; _ > e; ++e) T[e] = l(e * w, t, n)
            }
            function d(e, i, r) {
                var o, s, a = 0;
                do s = i + (r - i) / 2,
            ...
            function f(e) {
                for (var i = 0,
                r = 1,
                o = _ - 1; r != o && T[r] <= e; ++r) i += w; --r;
                var s = (e - T[r]) / (T[r + 1] - T[r]),
                a = i + s * w,
                l = u(a, t, n);
                return l >= g ? c(e, a) : 0 == l ? a: d(e, i, i + w)
            }
            function p() {
                C = !0,
                (t != i || n != r) && h()
            ...
            t = Math.max(t, 0),
            n = Math.max(n, 0);
            var T = b ? new Float32Array(_) : new Array(_),
            C = !1,
            k = function(e) {
                return C || p(),
                t === i && n === r ? e: 0 === e ? 0 : 1 === e ? 1 : l(f(e), i, r)
            };
        ...
        function u(t, e) {
            var i = t;
            return m.isString(t) ? _.Easings[t] || (i = !1) : i = m.isArray(t) && 1 === t.length ? a.apply(null, t) : m.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : m.isArray(t) && 4 === t.length ? l.apply(null, t) : !1,
        ...
        function c(t) {
            if (t) {
                ...
                for (var o = 0; i > o; o++) if (_.State.calls[o]) {
                    ...
                    for (var v = Math.min((e - f) / u.duration, 1), y = 0, w = l.length; w > y; y++) {
                        var x = l[y],
                        C = x.element;
                        if (s(C)) {
                            var k = !1;
                            if (u.display !== n && null !== u.display && "none" !== u.display) {
                                ...
                                b.setPropertyValue(C, "display", u.display)
                            }
                            u.visibility !== n && "hidden" !== u.visibility && b.setPropertyValue(C, "visibility", u.visibility);
                            for (var P in x) if ("element" !== P) {
                                ...
                                if (O.currentValue = $, "tween" === P) g = $;
                                    ...
                                    if (b.Hooks.registered[P]) {
                                        var E = b.Hooks.getRoot(P),
                                        z = s(C).rootPropertyValueCache[E];
                                        z && (O.rootPropertyValue = z)
                                    }
                                    var R = b.setPropertyValue(C, P, O.currentValue + (0 === parseFloat($) ? "": O.unitType), O.rootPropertyValue, O.scrollData);
                                    b.Hooks.registered[P] && (s(C).rootPropertyValueCache[E] = b.Normalizations.registered[E] ? b.Normalizations.registered[E]("extract", null, R[1]) : R[1]),
                                    "transform" === R[0] && (k = !0)
                                }
                            }
                            u.mobileHA && s(C).transformCache.translate3d === n && (s(C).transformCache.translate3d = "(0px, 0px, 0px)", k = !0),
                            k && b.flushTransformCache(C)
                        }
                    }
                    u.display !== n && "none" !== u.display && (_.State.calls[o][2].display = !1),
                    u.visibility !== n && "hidden" !== u.visibility && (_.State.calls[o][2].visibility = !1),
                    u.progress && u.progress.call(a[1], a[1], v, Math.max(0, f + u.duration - e), f, g),
                    1 === v && h(o)
                }
            }
        ...
        function h(t, e) {
            ...
            for (var i = _.State.calls[t][0], r = _.State.calls[t][1], o = _.State.calls[t][2], a = _.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                var h = i[u].element;
                if (e || o.loop || ("none" === o.display && b.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && b.setPropertyValue(h, "visibility", o.visibility)), o.loop !== !0 && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && s(h)) {
                    s(h).isAnimating = !1,
                    ...
                    o.mobileHA && (f = !0, delete s(h).transformCache.translate3d),
                ...
                a && o.loop !== !0 && a(r),
                s(h) && o.loop === !0 && !e && (d.each(s(h).tweensContainer,
                function(t, e) { / ^rotate / .test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0, e.startValue = 360),
            ...
            _.State.calls[t] = !1;
            for (var m = 0,
            g = _.State.calls.length; g > m; m++) if (_.State.calls[m] !== !1) {
                l = !0;
                break
            }
        ...
        var b = _.CSS = {
            ...
            Hooks: {
                ...
                register: function() {
                    ...
                    var i, n, r;
                    if (f) for (i in b.Hooks.templates) {
                        n = b.Hooks.templates[i],
                        r = n[0].split(" ");
                        var o = n[1].match(b.RegEx.valueSplit);
                        "Color" === r[0] && (r.push(r.shift()), o.push(o.shift()), b.Hooks.templates[i] = [r.join(" "), o.join(" ")])
                    }
                ...
                extractValue: function(t, e) {
                    ...
                    if (i) {
                        ...
                        e.toString().match(b.RegEx.valueSplit)[r]
                    }
                    return e
                },
                injectValue: function(t, e, i) {
                    ...
                    if (n) {
                        var r, o, s = n[0],
                        a = n[1];
                        return i = b.Hooks.cleanRootPropertyValue(s, i),
                        r = i.toString().match(b.RegEx.valueSplit),
                        r[a] = e,
                        o = r.join(" ")
                    }
                    return i
            ...
            Normalizations: {
                registered: {
                    clip: function(t, e, i) {
                        ...
                        case "extract":
                            var n;
                            return b.RegEx.wrappedValueAlreadyExtracted.test(i) ? n = i: (n = i.toString().match(b.RegEx.valueUnwrap), n = n ? n[1].replace(/,(\s+)?/g, " ") : i),
                            n;
                        case "inject":
                            return "rect(" + i + ")"
                        }
                ...
                register: function() {
                    9 >= f || _.State.isGingerbread || (b.Lists.transformsBase = b.Lists.transformsBase.concat(b.Lists.transforms3D));
                    for (var t = 0; t < b.Lists.transformsBase.length; t++) !
                    function() {
                        var e = b.Lists.transformsBase[t];
                        b.Normalizations.registered[e] = function(t, i, r) {
                            switch (t) {
                            case "name":
                                return "transform";
                            case "extract":
                            ...
                            case "inject":
                                ...
                                case "scal":
                                case "scale":
                                    _.State.isAndroid && s(i).transformCache[e] === n && 1 > r && (r = 1),
                                    o = !/(\d)$/i.test(r);
                                    break;
                                case "skew":
                                    o = !/(deg|\d)$/i.test(r);
                                ...
                                return o || (s(i).transformCache[e] = "(" + r + ")"),
                        ...
                        b.Normalizations.registered[e] = function(t, i, r) {
                            ...
                            case "extract":
                                ...
                                if (b.RegEx.wrappedValueAlreadyExtracted.test(r)) o = r;
                                    ...
                                    /^[A-z]+$/i.test(r) ? s = a[r] !== n ? a[r] : a.black: b.RegEx.isHex.test(r) ? s = "rgb(" + b.Values.hexToRgb(r).join(" ") + ")": /^rgba?\(/i.test(r) || (s = a.black),
                                    o = (s || r).toString().match(b.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                }
                                return 8 >= f || 3 !== o.split(" ").length || (o += " 1"),
                                o;
                            case "inject":
                                return 8 >= f ? 4 === r.split(" ").length && (r = r.split(/\s+/).slice(0, 3).join(" ")) : 3 === r.split(" ").length && (r += " 1"),
                                (8 >= f ? "rgb": "rgba") + "(" + r.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")"
                            }
                        }
                    } ()
                }
            ...
            Names: {
                ...
                SVGAttribute: function(t) {
                    ...
                    return (f || _.State.isAndroid && !_.State.isChrome) && (e += "|transform"),
                ...
                prefixCheck: function(t) {
                    ...
                    for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
                        var r;
                        if (r = 0 === i ? t: e[i] + t.replace(/^\w/,
                        function(t) {
                            return t.toUpperCase()
                        }), m.isString(_.State.prefixElement.style[r])) return _.State.prefixMatches[t] = r,
                        [r, !0]
                    }
                    return [t, !1]
                }
            ...
            getPropertyValue: function(t, i, r, o) {
                function a(t, i) {
                    ...
                    if (8 >= f) l = d.css(t, i);
                        ...
                        var u = !1;
                        if (/^(width|height)$/.test(i) && 0 === b.getPropertyValue(t, "display") && (u = !0, b.setPropertyValue(t, "display", b.Values.getDisplayType(t))), !o) {
                    ...
                    if ("auto" === l && /^(top|right|bottom|left)$/i.test(i)) {
                        var m = a(t, "position"); ("fixed" === m || "absolute" === m && /top|left/i.test(i)) && (l = d(t).position()[i] + "px")
                    }
                    return l
                }
                var l;
                if (b.Hooks.registered[i]) {
                    var u = i,
                    c = b.Hooks.getRoot(u);
                    r === n && (r = b.getPropertyValue(t, b.Names.prefixCheck(c)[0])),
                    b.Normalizations.registered[c] && (r = b.Normalizations.registered[c]("extract", t, r)),
                    l = b.Hooks.extractValue(u, r)
                } else if (b.Normalizations.registered[i]) {
                    var h, p;
                    h = b.Normalizations.registered[i]("name", t),
                    "transform" !== h && (p = a(t, b.Names.prefixCheck(h)[0]), b.Values.isCSSNullValue(p) && b.Hooks.templates[i] && (p = b.Hooks.templates[i][1])),
                    l = b.Normalizations.registered[i]("extract", t, p)
                }
                if (!/^[\d-]/.test(l)) if (s(t) && s(t).isSVG && b.Names.SVGAttribute(i)) if (/^(height|width)$/i.test(i)) try {
                    l = t.getBBox()[i]
                } catch(m) {
                    l = 0
            ...
            setPropertyValue: function(t, i, n, r, o) {
                ...
                else if (b.Normalizations.registered[i] && "transform" === b.Normalizations.registered[i]("name", t)) b.Normalizations.registered[i]("inject", t, n),
                a = "transform",
                n = s(t).transformCache[i];
                    ...
                    if (b.Hooks.registered[i]) {
                        var l = i,
                        u = b.Hooks.getRoot(i);
                        r = r || b.getPropertyValue(t, u),
                        n = b.Hooks.injectValue(l, n, r),
                        i = u
                    }
                    if (b.Normalizations.registered[i] && (n = b.Normalizations.registered[i]("inject", t, n), i = b.Normalizations.registered[i]("name", t)), a = b.Names.prefixCheck(i)[0], 8 >= f) try {
                        t.style[a] = n
                    } catch(c) {
                        _.debug && console.log("Browser does not support [" + n + "] for [" + a + "]")
                    } else s(t) && s(t).isSVG && b.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[a] = n;
            ...
            flushTransformCache: function(t) {
                ...
                if ((f || _.State.isAndroid && !_.State.isChrome) && s(t).isSVG) {
                    ...
                    d.each(s(t).transformCache,
                    function(e) {
                        return r = s(t).transformCache[e],
                        "transformPerspective" === e ? (o = r, !0) : (9 === f && "rotateZ" === e && (e = "rotate"), void(i += e + r + " "))
                    }),
                    o && (i = "perspective" + o + " " + i)
                }
        ...
        var x = function() {
            ...
            function r() {
                function t() {
                    function t(t, e) {
                        ...
                        r = n,
                        s = n;
                        return m.isArray(t) ? (i = t[0], !m.isArray(t[1]) && /^[\d-]/.test(t[1]) || m.isFunction(t[1]) || b.RegEx.isHex.test(t[1]) ? s = t[1] : (m.isString(t[1]) && !b.RegEx.isHex.test(t[1]) || m.isArray(t[1])) && (r = e ? t[1] : u(t[1], a.duration), t[2] !== n && (s = t[2]))) : i = t,
                        e || (r = r || a.easing),
                        m.isFunction(i) && (i = i.call(o, C, T)),
                        m.isFunction(s) && (s = s.call(o, C, T)),
                        [i || 0, r, s]
                    }
                    function h(t, e) {
                        var i, n;
                    ...
                    function f() {
                        ...
                        var a = 100,
                        l = {};
                        if (r && n) l.emToPx = R.lastEmToPx,
                        l.percentToPxWidth = R.lastPercentToPxWidth,
                        l.percentToPxHeight = R.lastPercentToPxHeight;
                        else {
                            ...
                            _.CSS.setPropertyValue(u, "position", t.position),
                            _.CSS.setPropertyValue(u, "fontSize", t.fontSize),
                            _.CSS.setPropertyValue(u, "boxSizing", "content-box"),
                            d.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"],
                            function(t, e) {
                                _.CSS.setPropertyValue(u, e, a + "%")
                            }),
                            _.CSS.setPropertyValue(u, "paddingLeft", a + "em"),
                            l.percentToPxWidth = R.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(u, "width", null, !0)) || 1) / a,
                            l.percentToPxHeight = R.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(u, "height", null, !0)) || 1) / a,
                            l.emToPx = R.lastEmToPx = (parseFloat(b.getPropertyValue(u, "paddingLeft")) || 1) / a,
                            t.myParent.removeChild(u)
                        }
                        return null === R.remToPx && (R.remToPx = parseFloat(b.getPropertyValue(i.body, "fontSize")) || 16),
                        null === R.vwToPx && (R.vwToPx = parseFloat(e.innerWidth) / 100, R.vhToPx = parseFloat(e.innerHeight) / 100),
                        l.remToPx = R.remToPx,
                        l.vwToPx = R.vwToPx,
                        l.vhToPx = R.vhToPx,
                    ...
                    if ("scroll" === $) {
                        var w, x, k, S = /^x$/i.test(a.axis) ? "Left": "Top",
                        O = parseFloat(a.offset) || 0;
                        a.container ? m.isWrapped(a.container) || m.isNode(a.container) ? (a.container = a.container[0] || a.container, w = a.container["scroll" + S], k = w + d(o).position()[S.toLowerCase()] + O) : a.container = null: (w = _.State.scrollAnchor[_.State["scrollProperty" + S]], x = _.State.scrollAnchor[_.State["scrollProperty" + ("Left" === S ? "Top": "Left")]], k = d(o).offset()[S.toLowerCase()] + O),
                        l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: w,
                        ...
                        for (var F in A) if ("element" !== F) {
                            ...
                            A[F].startValue = A[F].currentValue = A[F].endValue,
                            A[F].endValue = E,
                            m.isEmptyObject(y) || (A[F].easing = a.easing),
                            _.debug && console.log("reverse tweensContainer (" + F + "): " + JSON.stringify(A[F]), o)
                        }
                        l = A
                    } else if ("start" === $) {
                        var A;
                        s(o).tweensContainer && s(o).isAnimating === !0 && (A = s(o).tweensContainer),
                        d.each(g,
                        function(e, i) {
                            if (RegExp("^" + b.Lists.colors.join("$|^") + "$").test(e)) {
                                ...
                                if (b.RegEx.isHex.test(o)) {
                                    for (var l = ["Red", "Green", "Blue"], u = b.Values.hexToRgb(o), c = a ? b.Values.hexToRgb(a) : n, h = 0; h < l.length; h++) {
                                        var d = [u[h]];
                                        s && d.push(s),
                                        c !== n && d.push(c[h]),
                                        g[e + l[h]] = d
                        ...
                        for (var z in g) {
                            ...
                            var N = b.Hooks.getRoot(z),
                            q = !1;
                            if (s(o).isSVG || "tween" === N || b.Names.prefixCheck(N)[1] !== !1 || b.Normalizations.registered[N] !== n) { (a.display !== n && null !== a.display && "none" !== a.display || a.visibility !== n && "hidden" !== a.visibility) && /opacity|filter/.test(z) && !j && 0 !== M && (j = 0),
                                a._cacheValues && A && A[z] ? (j === n && (j = A[z].endValue + A[z].unitType), q = s(o).rootPropertyValueCache[N]) : b.Hooks.registered[z] ? j === n ? (q = b.getPropertyValue(o, N), j = b.getPropertyValue(o, z, q)) : q = b.Hooks.templates[N][1] : j === n && (j = b.getPropertyValue(o, z));
                                var H, B, W, V = !1;
                                if (H = h(z, j), j = H[0], W = H[1], H = h(z, M), M = H[0].replace(/^([+-\/*])=/,
                                function(t, e) {
                                    return V = e,
                                    ""
                    ...
                    l.element && (b.Values.addClass(o, "velocity-animating"), D.push(l), "" === a.queue && (s(o).tweensContainer = l, s(o).opts = a), s(o).isAnimating = !0, C === T - 1 ? (_.State.calls.push([D, p, a, null, P.resolver]), _.State.isTicking === !1 && (_.State.isTicking = !0, c())) : C++)
                }
                var r, o = this,
                a = d.extend({},
                _.defaults, y),
                l = {};
                switch (s(o) === n && _.init(o), parseFloat(a.delay) && a.queue !== !1 && d.queue(o, a.queue,
                function(t) {
                ...
                a.queue === !1 ? a.delay ? setTimeout(t, a.delay) : t() : d.queue(o, a.queue,
                function(e, i) {
            ...
            var a, l, f, p, g, y, w = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || m.isString(arguments[0].properties));
            if (m.isWrapped(this) ? (a = !1, f = 0, p = this, l = this) : (a = !0, f = 1, p = w ? arguments[0].elements || arguments[0].e: arguments[0]), p = o(p)) {
                ...
                case "stop":
                    ...
                    function(t, e) {
                        ...
                        "finishAll" !== g || y !== !0 && !m.isString(y) || (d.each(d.queue(e, m.isString(y) ? y: ""),
                        function(t, e) {
                            m.isFunction(e) && e()
                    ...
                    function(t, e) {
                        ...
                        function(i, r) {
                            var o = y === n ? "": y;
                            return o === !0 || e[2].queue === o || y === n && e[2].queue === !1 ? void d.each(p,
                            function(i, n) {
                                n === r && ((y === !0 || m.isString(y)) && (d.each(d.queue(n, m.isString(y) ? y: ""),
                                function(t, e) {
                                    m.isFunction(e) && e(null, !0)
                                }), d.queue(n, m.isString(y) ? y: "", [])), "stop" === g ? (s(n) && s(n).tweensContainer && o !== !1 && d.each(s(n).tweensContainer,
                                function(t, e) {
                ...
                default:
                    if (!d.isPlainObject(g) || m.isEmptyObject(g)) {
                        if (m.isString(g) && _.Redirects[g]) {
                            ...
                            F = A.duration,
                            E = A.delay || 0;
                            return A.backwards === !0 && (p = d.extend(!0, [], p).reverse()),
                            d.each(p,
                            function(t, e) {
                                parseFloat(A.stagger) ? A.delay = E + parseFloat(A.stagger) * t: m.isFunction(A.stagger) && (A.delay = E + A.stagger.call(e, t, T)),
                                A.drag && (A.duration = parseFloat(F) || (/^(callout|transition)/.test(g) ? 1e3: v), A.duration = Math.max(A.duration * (A.backwards ? 1 - t / T: (t + 1) / T), .75 * A.duration, 200)),
                                _.Redirects[g].call(e, e, A || {},
                                t, T, p, P.promise ? P: n)
                            }),
                            t()
                        }
                        var z = "Velocity: First argument (" + g + ") was not a property map, a known action, or a registered redirect. Aborting.";
                        return P.promise ? P.rejecter(new Error(z)) : console.log(z),
                        t()
                    }
                    $ = "start"
                }
                ...
                if (A.loop = parseInt(A.loop), L = 2 * A.loop - 1, A.loop) for (var M = 0; L > M; M++) {
                    ...
                    M === L - 1 && (I.display = A.display, I.visibility = A.visibility, I.complete = A.complete),
                    x(p, "reverse", I)
                }
                return t()
            }
        ...
        return _.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange",
        function() {
...
function(t) {
    ...
    function e(t) {
        ...
        if (String(t).match(s)) return String(t).match(/^[0-9]*$/) && (t = Number(t)),
    ...
    function n(t) {
        return function(e) {
            ...
            s = n.length; s > o; ++o) {
                ...
                d = null;
                a = a[2],
                l.hasOwnProperty(a) && (d = l[a], d = Number(t[d])),
                null !== d && ("!" === c && (d = r(h, d)), "" === c && 10 > d && (d = "0" + d.toString()), e = e.replace(u, d.toString()))
            }
            return e = e.replace(/%%/, "%")
        }
    }
    function r(t, e) {
        var i = "s",
        n = "";
        return t && (t = t.replace(/(:|;|\s)/gi, "").split(/\,/), 1 === t.length ? i = t[0] : (n = t[0], i = t[1])),
        1 === Math.abs(e) ? n: i
    }
    var o = [],
    s = [],
    ...
    u = function(e, i, n) {
        ...
        n && ("function" == typeof n ? (this.$el.on("update.countdown", n), this.$el.on("stoped.countdown", n), this.$el.on("finish.countdown", n)) : this.options = t.extend({},
        a, n)),
        this.setFinalDate(i),
        this.start()
    };
    t.extend(u.prototype, {
        ...
        update: function() {
            ...
            this.totalSecsLeft !== e && i && (this.totalSecsLeft = e, this.elapsed = n >= this.finalDate, this.offset = {
...
function() {
    ...
    n.emitEvent = function(t, e) {
        ...
        for (r in s) if (s.hasOwnProperty(r)) for (n = s[r].length; n--;) i = s[r][n],
    ...
    function o(e) {
        ...
        function o(t) {
            if (n(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                T = s && h,
                C = i(e.width);
                C !== !1 && (o.width = C + (T ? 0 : v + b));
                var k = i(e.height);
                return k !== !1 && (o.height = k + (T ? 0 : y + x)),
                o.innerWidth = o.width - (v + b),
...
function(t, e, i, n, r) {
    ...
    s.prototype.moveTo = d ? s.prototype._transitionTo: s.prototype.goTo,
    ...
    s.prototype.transition = s.prototype[c ? "_transition": "_nonTransition"],
...
function(t, e, i, n, r, o) {
    ...
    s.prototype._layoutItems = function(t, e) {
        if (this._emitCompleteOnItems("layout", t), t && t.length) {
            for (var i = [], n = 0, r = t.length; r > n; n++) {
                ...
                s.item = o,
                s.isInstant = e || o.isLayoutInstant,
                i.push(s)
            }
    ...
    s.create = function(t, e) {
        ...
        return Object.create ? i.prototype = Object.create(s.prototype) : r.extend(i.prototype, s.prototype),
    ...
    d.prototype._filter = function(t) {
        ...
        for (var i = [], n = [], r = [], o = this._getFilterTest(e), s = 0, a = t.length; a > s; s++) {
            ...
            if (!l.isIgnored) {
                var u = o(l);
                u && i.push(l),
                u && l.isHidden ? n.push(l) : u || l.isHidden || r.push(l)
            }
        }
        return {
            matches: i,
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global: this || window; (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function(t, e, i) {
        ...
        c.updateTo = function(t, e) {
            ...
            o && this.render(0, !0, !0);
                ...
                this._initted = !1,
                this.render(s, !0, !1)
            } else if (this._initted = !1, this._init(), this._time > 0 || o) for (var a, l = 1 / (1 - r), u = this._firstPT; u;) a = u.s + u.c,
            u.c *= l,
            u.s = a - u.c,
            u = u._next;
            return this
        ...
        c.render = function(t, e, i) {
            ...
            for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== p && t >= 0 && (this._active = !0), 0 === m && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === v) && (e || this._callback("onStart"))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s,
            o = o._next;
        ...
        o.staggerTo = o.allTo = function(t, e, s, a, c, d, f) {
            ...
            w = function() {
                ...
                c.apply(f || s.callbackScope || this, d || h)
            },
            b = s.cycle,
        ...
        var d = function(t, e) {
            for (var n = [], r = 0, o = t._first; o;) o instanceof i ? n[r++] = o: (e && (n[r++] = o), n = n.concat(d(o, e)), r = n.length),
            o = o._next;
            return n
        },
        ...
        o.killChildTweensOf = function(t, e) {
            if (null != t) {
                ...
                if ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t)), u(t)) for (h = t.length; --h > -1;) o.killChildTweensOf(t[h], e);
                    ...
                    r = [];
                    for (c in f) for (s = f[c].target.parentNode; s;) s === t && (r = r.concat(f[c].tweens)),
                    s = s.parentNode;
                    for (d = r.length, h = 0; d > h; h++) e && r[h].totalTime(r[h].totalDuration()),
                    r[h]._enabled(!1, !1)
                }
            }
        };
        var p = function(t, i, n, r) {
            ...
            n = n !== !1,
            r = r !== !1;
            for (var o, s, a = f(r), l = i && n && r, u = a.length; --u > -1;) s = a[u],
    ...
    function(t, e, i) {
        ...
        g.staggerTo = function(t, e, r, o, s, l, u, c) {
            ...
            v = r.cycle;
            for ("string" == typeof t && (t = i.selector(t) || t), t = t || [], a(t) && (t = m(t)), o = o || 0, 0 > o && (t = m(t), t.reverse(), o *= -1), p = 0; p < t.length; p++) h = d(r),
            h.startAt && (h.startAt = d(h.startAt), h.startAt.cycle && f(h.startAt, t, p)),
            v && (f(h, t, p), null != h.duration && (e = h.duration, delete h.duration)),
            g.to(t[p], e, h, p * o);
            return this.add(g, s)
        },
        ...
        n.exportRoot = function(t, e) {
            ...
            var r, o, s = new n(t),
            a = s._timeline;
            for (null == e && (e = !0), a._remove(s, !0), s._startTime = 0, s._rawPrevTime = s._time = s._totalTime = a._time, r = a._first; r;) o = r._next,
        ...
        g.add = function(r, o, s, a) {
            ...
            if (e.prototype.add.call(this, r, o), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration()) for (f = this, p = f.rawTime() > r._startTime; f._timeline;) p && f._timeline.smoothChildTiming ? f.totalTime(f._totalTime, !0) : f._gc && f._enabled(!0, !1),
            f = f._timeline;
            return this
        },
        g.remove = function(e) {
        ...
        g.render = function(t, e, i) {
            ...
            this._reversed || this._hasPausedChild() || (o = !0, a = "onComplete", l = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || this._rawPrevTime < 0 || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (l = !0, this._rawPrevTime > r && (a = "onReverseComplete"))),
            this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t: r,
            t = f + 1e-4;
            else if (1e-7 > t) if (this._totalTime = this._time = 0, (0 !== p || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (a = "onReverseComplete", o = this._reversed), 0 > t) this._active = !1,
            this._timeline.autoRemoveChildren && this._reversed ? (l = o = !0, a = "onReverseComplete") : this._rawPrevTime >= 0 && this._first && (l = !0),
            this._rawPrevTime = t;
            else {
                if (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t: r, 0 === t && o) for (n = this._first; n && 0 === n._startTime;) n._duration || (o = !1),
                n = n._next;
                t = 0,
                this._initted || (l = !0)
            } else {
            ...
            if (this._time !== p && this._first || i || l || h) {
                ...
                a && (this._gc || (m === this._startTime || g !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (o && (u.length && c(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[a] && this._callback(a)))
            }
        },
        ...
        g.getChildren = function(t, e, n, r) {
            r = r || -9999999999;
            for (var o = [], s = this._first, a = 0; s;) s._startTime < r || (s instanceof i ? e !== !1 && (o[a++] = s) : (n !== !1 && (o[a++] = s), t !== !1 && (o = o.concat(s.getChildren(!0, e, n)), a = o.length))),
            s = s._next;
            return o
        },
    ...
    function(t, e, i) {
        ...
        c.render = function(t, e, i) {
            ...
            this._reversed || this._hasPausedChild() || (o = !0, u = "onComplete", c = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || 0 > w || w === r) && w !== t && this._first && (c = !0, w > r && (u = "onReverseComplete"))),
            this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t: r,
            this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = m, t = m + 1e-4);
            else if (1e-7 > t) if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== g || 0 === m && w !== r && (w > 0 || 0 > t && w >= 0) && !this._locked) && (u = "onReverseComplete", o = this._reversed), 0 > t) this._active = !1,
            this._timeline.autoRemoveChildren && this._reversed ? (c = o = !0, u = "onReverseComplete") : w >= 0 && this._first && (c = !0),
            this._rawPrevTime = t;
            else {
                if (this._rawPrevTime = m || !e || t || this._rawPrevTime === t ? t: r, 0 === t && o) for (n = this._first; n && 0 === n._startTime;) n._duration || (o = !1),
                n = n._next;
                t = 0,
                this._initted || (c = !0)
            } else if (0 === m && 0 > w && (c = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (h = m + this._repeatDelay, this._cycle = this._totalTime / h >> 0, 0 !== this._cycle && this._cycle === this._totalTime / h && t >= v && this._cycle--, this._time = this._totalTime - this._cycle * h, this._yoyo && 0 !== (1 & this._cycle) && (this._time = m - this._time), this._time > m ? (this._time = m, t = m + 1e-4) : this._time < 0 ? this._time = t = 0 : t = this._time)), this._hasPause && !this._forcingPlayhead && !e) {
                if (t = this._time, t >= g) for (n = this._first; n && n._startTime <= t && !d;) n._duration || "isPause" !== n.data || n.ratio || 0 === n._startTime && 0 === this._rawPrevTime || (d = n),
                n = n._next;
            ...
            if (this._cycle !== x && !this._locked) {
                ...
                if (C && (g = T ? m + 1e-4: -1e-4, this.render(g, !0, !1)), this._locked = !1, this._paused && !b) return;
                this._time = $,
                this._totalTime = k,
                this._cycle = S,
                this._rawPrevTime = P
            ...
            if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== v && t > 0 && (this._active = !0), 0 === v && this.vars.onStart && (0 === this._totalTime && this._totalDuration || e || this._callback("onStart")), f = this._time, f >= g) for (n = this._first; n && (l = n._next, f === this._time && (!this._paused || b));)(n._active || n._startTime <= this._time && !n._paused && !n._gc) && (d === n && this.pause(), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
            n = l;
            ...
            u && (this._locked || this._gc || (y === this._startTime || _ !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (o && (s.length && a(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[u] && this._callback(u)))
        },
    ...
    function() {
        ...
        u = function(t, r, o, s, a) {
            var u, c, h, d, f, p, m, g, v, y, _, w, b, x = t.length - 1,
            T = 0,
            C = t[0].a;
            for (u = 0; x > u; u++) f = t[T],
            c = f.a,
            h = f.d,
            d = t[T + 1].d,
            a ? (_ = e[u], w = i[u], b = (w + _) * r * .25 / (s ? .5 : n[u] || .5), p = h - (h - c) * (s ? .5 * r: 0 !== _ ? b / _: 0), m = h + (d - h) * (s ? .5 * r: 0 !== w ? b / w: 0), g = h - (p + ((m - p) * (3 * _ / (_ + w) + .5) / 4 || 0))) : (p = h - (h - c) * r * .5, m = h + (d - h) * r * .5, g = h - (p + m) / 2),
            p += g,
            m += g,
            f.c = v = p,
            0 !== u ? f.b = C: f.b = C = f.a + .6 * (f.c - f.a),
            f.da = h - c,
            f.ca = v - c,
            f.ba = C - c,
            o ? (y = l(c, C, v, h), t.splice(T, 1, y[0], y[1], y[2], y[3]), T += 4) : T++,
            C = m;
            f = t[T],
            f.b = C,
            f.c = C + .4 * (f.d - C),
            ...
            f.ca = f.c - f.a,
            f.ba = C - f.a,
            o && (y = l(f.a, C, f.c, f.d), t.splice(T, 1, y[0], y[1], y[2], y[3]))
        },
        c = function(t, n, r, o) {
            var a, l, u, c, h, d, f = [];
            if (o) for (t = [o].concat(t), l = t.length; --l > -1;)"string" == typeof(d = t[l][n]) && "=" === d.charAt(1) && (t[l][n] = o[n] + Number(d.charAt(0) + d.substr(2)));
            if (a = t.length - 2, 0 > a) return f[0] = new s(t[0][n], 0, 0, t[ - 1 > a ? 0 : 1][n]),
            f;
            for (l = 0; a > l; l++) u = t[l][n],
            c = t[l + 1][n],
            f[l] = new s(u, 0, 0, c),
        ...
        h = function(t, o, s, l, h, d) {
            ...
            if (t.length > 1) {
                for (w = t[t.length - 1], _ = !0, f = x.length; --f > -1;) if (p = x[f], Math.abs(T[p] - w[p]) > .05) {
                    _ = !1;
                    break
                }
                _ && (t = t.concat(), d && t.unshift(d), t.push(t[1]), d = t[t.length - 3])
            }
            for (e.length = i.length = n.length = 0, f = x.length; --f > -1;) p = x[f],
            r[p] = -1 !== h.indexOf("," + p + ","),
            b[p] = c(t, p, r[p], d);
            for (f = e.length; --f > -1;) e[f] = Math.sqrt(e[f]),
            i[f] = Math.sqrt(i[f]);
            if (!l) {
                for (f = x.length; --f > -1;) if (r[p]) for (m = b[x[f]], y = m.length - 1, g = 0; y > g; g++) v = m[g + 1].da / i[g] + m[g].da / e[g] || 0,
                n[g] = (n[g] || 0) + v * v;
                for (f = n.length; --f > -1;) n[f] = Math.sqrt(n[f])
            }
            for (f = x.length, g = s ? 4 : 1; --f > -1;) p = x[f],
            m = b[p],
            u(m, o, s, l, r[p]),
        ...
        d = function(t, e, i) {
            ...
            for (u = y.length; --u > -1;) {
                for (d = y[u], m[d] = l = [], f = 0, h = t.length, c = 0; h > c; c++) n = null == i ? t[c][d] : "string" == typeof(p = t[c][d]) && "=" === p.charAt(1) ? i[d] + Number(p.charAt(0) + p.substr(2)) : Number(p),
                v && c > 1 && h - 1 > c && (l[f++] = (n + l[f - 2]) / 2),
                l[f++] = n;
                for (h = f - g + 1, f = 0, c = 0; h > c; c += g) n = l[c],
                r = l[c + 1],
                o = l[c + 2],
                a = 2 === g ? 0 : l[c + 3],
                l[f++] = p = 3 === g ? new s(n, r, o, a) : new s(n, (2 * r + n) / 3, (2 * r + o) / 3, o);
                l.length = f
            }
            return m
        },
        f = function(t, e, i) {
            for (var n, r, o, s, a, l, u, c, h, d, f, p = 1 / i,
            m = t.length; --m > -1;) for (d = t[m], o = d.a, s = d.d - o, a = d.c - o, l = d.b - o, n = r = 0, c = 1; i >= c; c++) u = p * c,
            h = 1 - u,
        ...
        p = function(t, e) {
            ...
            for (r = s.length, n = 0; r > n; n++) l += Math.sqrt(s[n]),
            o = n % e,
            d[o] = l,
            o === c && (u += l, o = n / e >> 0, h[o] = d, a[o] = u, l = 0, d = []);
            return {
                length: u,
                lengths: a,
                segments: h
        ...
        m = _gsScope._gsDefine.plugin({
            ...
            set: function(e) {
                ...
                a = (e - i * (1 / d)) * d;
                for (n = 1 - a, r = this._props.length; --r > -1;) o = this._props[r],
                s = this._beziers[o][i],
                ...
                if (this._autoRotate) {
                    ...
                    for (r = T.length; --r > -1;) o = T[r][2],
                    b = T[r][3] || 0,
                    x = T[r][4] === !0 ? 1 : t,
                    s = this._beziers[T[r][0]],
                    g = this._beziers[T[r][1]],
                    s && g && (s = s[i], g = g[i], v = s.a + (s.b - s.a) * a, _ = s.b + (s.c - s.b) * a, v += (_ - v) * a, _ += (s.c + (s.d - s.c) * a - _) * a, y = g.a + (g.b - g.a) * a, w = g.b + (g.c - g.b) * a, y += (w - y) * a, w += (g.c + (g.d - g.c) * a - w) * a, l = m ? Math.atan2(w - y, _ - v) * x + b: this._initialRotations[r], this._mod[o] && (l = this._mod[o](l, p)), f[o] ? p[o](l) : p[o] = l)
                }
            }
        }),
        g = m.prototype;
            ...
            if (t) {
                ...
                e._registerComplexSpecialProp("bezier", {
                    parser: function(t, e, o, s, a, l) {
                        ...
                        g = {};
                        if (0 > f) return a;
                        for (u = 0; f >= u; u++) h = i(t, d[u], s, a, l, f !== u),
                        p[u] = h.end;
                        for (c in e) g[c] = e[c];
                        return g.values = p,
                        ...
                        !g.autoRotate || g.autoRotate instanceof Array || (u = g.autoRotate === !0 ? 0 : Number(g.autoRotate), g.autoRotate = null != h.end.left ? [["left", "top", "rotation", u, !1]] : null != h.end.x ? [["x", "y", "rotation", u, !1]] : !1),
                        g.autoRotate && (s._transform || s._enableTransforms(!1), h.autoRotate = s._target._gsTransform, h.proxy.rotation = h.autoRotate.rotation || 0, s._overwriteProps.push("rotation")),
    ...
    function(t, e) {
        ...
        V = function() {
            ...
            p = d && Number(W.substr(W.indexOf("Version/") + 8, 1)) < 6,
        ...
        et = function(t, e) {
            ...
            ( - 1 === r.indexOf("-transform") || $t === r) && (o[r.replace($, A)] = e.getPropertyValue(r));
        ...
        it = function(t, e, i, n, r) {
            var o, s, a, l = {},
            u = t.style;
            for (s in i)"cssText" !== s && "length" !== s && isNaN(s) && (e[s] !== (o = i[s]) || r && r[s]) && -1 === s.indexOf("Origin") && ("number" == typeof o || "string" == typeof o) && (l[s] = "auto" !== o || "left" !== s && "top" !== s ? "" !== o && "auto" !== o && "none" !== o || "string" != typeof e[s] || "" === e[s].replace(b, "") ? o: 0 : tt(t, s), void 0 !== u[s] && (a = new vt(u, s, u[s], a)));
        ...
        ot = function(t, e, i) {
            ...
            r = nt[e],
            o = r.length;
            for (i = i || Z(t, null); --o > -1;) n -= parseFloat(K(t, "padding" + r[o], i, !0)) || 0,
        ...
        st = function(t, e) {
            ...
            e && (e.oxp = -1 !== r.indexOf("%"), e.oyp = -1 !== o.indexOf("%"), e.oxr = "=" === r.charAt(1), e.oyr = "=" === o.charAt(1), e.ox = parseFloat(r.replace(b, "")), e.oy = parseFloat(o.replace(b, "")), e.v = t),
            e || t
        },
        at = function(t, e) {
        ...
        ut = function(t, e, i, n) {
            ...
            return "function" == typeof t && (t = t(v, g)),
            null == t ? a = e: "number" == typeof t ? a = t: (r = 360, o = t.split("_"), l = "=" === t.charAt(1), s = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(o[0].substr(2)) : parseFloat(o[0])) * ( - 1 === t.indexOf("rad") ? 1 : M) - (l ? 0 : e), o.length && (n && (n[i] = e + s), -1 !== t.indexOf("short") && (s %= r, s !== s % (r / 2) && (s = 0 > s ? s + r: s - r)), -1 !== t.indexOf("_cw") && 0 > s ? s = (s + 9999999999 * r) % r - (s / r | 0) * r: -1 !== t.indexOf("ccw") && s > 0 && (s = (s - 9999999999 * r) % r - (s / r | 0) * r)), a = e + s),
            u > a && a > -u && (a = 0),
            a
        },
        ct = {
        ...
        dt = s.parseColor = function(t, e) {
            ...
            return e && !d && (n = i[0] / 255, r = i[1] / 255, o = i[2] / 255, u = Math.max(n, r, o), c = Math.min(n, r, o), l = (u + c) / 2, u === c ? s = a = 0 : (h = u - c, a = l > .5 ? h / (2 - u - c) : h / (u + c), s = u === n ? (r - o) / h + (o > r ? 6 : 0) : u === r ? (o - n) / h + 2 : (n - r) / h + 4, s *= 60), i[0] = s + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0),
            i
        },
        ft = function(t, e) {
        ...
        s.colorStringFilter = function(t) {
            var e, i = t[0] + t[1];
            pt.test(i) && (e = -1 !== i.indexOf("hsl(") || -1 !== i.indexOf("hsla("), t[0] = ft(t[0], e), t[1] = ft(t[1], e)),
            pt.lastIndex = 0
        },
        ...
        var mt = function(t, e, i, n) {
            ...
            function(t) {
                ...
                if (e = (t.match(pt) || [o])[0], d = t.split(e).join("").match(w) || [], f = d.length, c > f--) for (; ++f < c;) d[f] = i ? d[(f - 1) / 2 | 0] : s[f];
                ...
                if (e = t.match(w) || [], d = e.length, c > d--) for (; ++d < c;) e[d] = i ? e[(d - 1) / 2 | 0] : s[d];
                return a + e.join(u) + l
            }: function(t) {
                return t
            }
        ...
        yt = (B._parseToProxy = function(t, e, i, n, r, o) {
            ...
            for (i._transform = null, I = e, n = c = i.parse(t, e, n, r), I = m, o && (i._transform = p, h && (h._prev = null, h._prev && (h._prev._next = null))); n && n !== h;) {
                if (n.type <= 1 && (a = n.p, f[a] = n.s + n.c, d[a] = n.s, o || (u = new vt(n, "s", a, u, n.r), n.c = 0), 1 === n.type)) for (s = n.l; --s > 0;) l = "xn" + s,
                a = n.p + "_" + l,
                f[a] = n.data[l],
                d[a] = n[l],
        ...
        wt = s.parseComplex = function(t, e, i, n, r, o, a, l, u, h) {
            i = i || o || "",
            "function" == typeof n && (n = n(v, g)),
            a = new yt(t, e, 0, 0, a, h ? 2 : 1, null, !1, l, i, n),
            n += "",
            r && pt.test(n + i) && (n = [i, n], s.colorStringFilter(n), i = n[0], n = n[1]);
            var d, f, p, m, w, b, x, T, C, k, S, P, $, O = i.split(", ").join(",").split(" "),
            A = n.split(", ").join(",").split(" "),
            F = O.length,
            E = c !== !1;
            for (( - 1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (O = O.join(" ").replace(R, ", ").split(" "), A = A.join(" ").replace(R, ", ").split(" "), F = O.length), F !== A.length && (O = (o || "").split(" "), F = O.length), a.plugin = u, a.setRatio = h, pt.lastIndex = 0, d = 0; F > d; d++) if (m = O[d], w = A[d], T = parseFloat(m), T || 0 === T) a.appendXtra("", T, at(w, T), w.replace(_, ""), E && -1 !== w.indexOf("px"), !0);
            else if (r && pt.test(m)) P = w.indexOf(")") + 1,
            P = ")" + (P ? w.substr(P) : ""),
            $ = -1 !== w.indexOf("hsl") && V,
            m = dt(m, $),
            w = dt(w, $),
            C = m.length + w.length > 6,
            C && !V && 0 === w[3] ? (a["xs" + a.l] += a.l ? " transparent": "transparent", a.e = a.e.split(A[d]).join("transparent")) : (V || (C = !1), $ ? a.appendXtra(C ? "hsla(": "hsl(", m[0], at(w[0], m[0]), ",", !1, !0).appendXtra("", m[1], at(w[1], m[1]), "%,", !1).appendXtra("", m[2], at(w[2], m[2]), C ? "%,": "%" + P, !1) : a.appendXtra(C ? "rgba(": "rgb(", m[0], w[0] - m[0], ",", !0, !0).appendXtra("", m[1], w[1] - m[1], ",", !0).appendXtra("", m[2], w[2] - m[2], C ? ",": P, !0), C && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (w.length < 4 ? 1 : w[3]) - m, P, !1))),
            pt.lastIndex = 0;
            else if (b = m.match(y)) {
                if (x = w.match(_), !x || x.length !== b.length) return a;
                for (p = 0, f = 0; f < b.length; f++) S = b[f],
                k = m.indexOf(S, p),
                a.appendXtra(m.substr(p, k - p), Number(S), at(x[f], S), "", E && "px" === m.substr(k + S.length, 2), 0 === f),
                p = k + S.length;
                a["xs" + a.l] += m.substr(p)
        ...
        bt = 9;
        for (u = yt.prototype, u.l = u.pr = 0; --bt > 0;) u["xn" + bt] = 0,
        u["xs" + bt] = "";
        u.xs0 = "",
        ...
        u.appendXtra = function(t, e, i, n, r, o) {
            ...
            i || 0 === a || s.plugin ? (s.l++, s.type = s.setRatio ? 2 : 1, s["xs" + s.l] = n || "", a > 0 ? (s.data["xn" + a] = e + i, s.rxp["xn" + a] = r, s["xn" + a] = e, s.plugin || (s.xfirst = new yt(s, "xn" + a, e, i, s.xfirst || s, 0, s.n, r, s.pr), s.xfirst.xs0 = 0), s) : (s.data = {
                s: e + i
            },
            s.rxp = {},
        ...
        Tt = B._registerComplexSpecialProp = function(t, e, i) {
            ...
            var n, r, o = t.split(","),
            s = e.defaultValue;
            for (i = i || [s], n = 0; n < o.length; n++) e.prefix = 0 === n && e.prefix,
        ...
        u.parseComplex = function(t, e, i, n, r, o) {
            ...
            if (this.multi && (R.test(i) || R.test(e) ? (a = e.replace(R, "|").split("|"), l = i.replace(R, "|").split("|")) : d && (a = [e], l = [i])), l) {
                for (u = l.length > a.length ? l.length: a.length, s = 0; u > s; s++) e = a[s] = a[s] || this.dflt,
                i = l[s] = l[s] || this.dflt,
                d && (c = e.indexOf(d), h = i.indexOf(d), c !== h && ( - 1 === h ? a[s] = a[s].split(d).join("") : -1 === c && (a[s] += " " + d)));
                e = a.join(", "),
                i = l.join(", ")
            }
        ...
        Dt = function() {
            ...
            return j.createElementNS && !n && (t = zt("svg", Rt), e = zt("rect", t, {
                ...
                height: 50,
                x: 100
            }), i = e.getBoundingClientRect().width, e.style[Ot] = "50% 50%", e.style[Pt] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(f && At), Rt.removeChild(t)),
            n
        } (),
        Lt = function(t, e, i, n, r, o) {
            var a, l, u, c, h, d, f, p, m, g, v, y, _, w, b = t._gsTransform,
            x = Nt(t, !0);
            b && (_ = b.xOrigin, w = b.yOrigin),
            (!n || (a = n.split(" ")).length < 2) && (f = t.getBBox(), e = st(e).split(" "), a = [( - 1 !== e[0].indexOf("%") ? parseFloat(e[0]) / 100 * f.width: parseFloat(e[0])) + f.x, ( - 1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * f.height: parseFloat(e[1])) + f.y]),
            i.xOrigin = c = parseFloat(a[0]),
            i.yOrigin = h = parseFloat(a[1]),
            n && x !== jt && (d = x[0], f = x[1], p = x[2], m = x[3], g = x[4], v = x[5], y = d * m - f * p, l = c * (m / y) + h * ( - p / y) + (p * v - m * g) / y, u = c * ( - f / y) + h * (d / y) - (d * v - f * g) / y, c = i.xOrigin = a[0] = l, h = i.yOrigin = a[1] = u),
            b && (o && (i.xOffset = b.xOffset, i.yOffset = b.yOffset, b = i), r || r !== !1 && s.defaultSmoothOrigin !== !1 ? (l = c - _, u = h - w, b.xOffset += l * x[0] + u * x[2] - l, b.yOffset += l * x[1] + u * x[3] - u) : b.xOffset = b.yOffset = 0),
        ...
        Nt = function(t, e) {
            ...
            for (r = (n || "").match(y) || [], bt = r.length; --bt > -1;) o = Number(r[bt]),
            r[bt] = (s = o - (o |= 0)) ? (s * u + (0 > s ? -.5 : .5) | 0) / u + o: o;
        ...
        qt = B.getTransform = function(t, i, n, r) {
            ...
            if (d.svg = !(!t.getBBox || !It(t)), d.svg && (Lt(t, K(t, Ot, i, !1, "50% 50%") + "", d, t.getAttribute("data-svg-origin")), kt = s.useSVGTransformAttr || Dt), o = Nt(t), o !== jt) {
                if (16 === o.length) {
                    ...
                    I = o[11],
                    j = Math.atan2(O, z);
                    d.zOrigin && (L = -d.zOrigin, R = F * L - o[12], D = E * L - o[13], L = z * L + d.zOrigin - o[14]),
                    d.rotationX = j * M,
                    j && (b = Math.cos( - j), x = Math.sin( - j), y = P * b + F * x, _ = $ * b + E * x, w = O * b + z * x, F = P * -x + F * b, E = $ * -x + E * b, z = O * -x + z * b, I = A * -x + I * b, P = y, $ = _, O = w),
                    j = Math.atan2( - k, z),
                    d.rotationY = j * M,
                    j && (b = Math.cos( - j), x = Math.sin( - j), y = T * b - F * x, _ = C * b - E * x, w = k * b - z * x, E = C * x + E * b, z = k * x + z * b, I = S * x + I * b, T = y, C = _, k = w),
                    j = Math.atan2(C, T),
                    d.rotation = j * M,
                    j && (b = Math.cos( - j), x = Math.sin( - j), T = T * b + P * x, _ = C * b + $ * x, $ = C * -x + $ * b, O = k * -x + O * b, C = _),
                    d.rotationX && Math.abs(d.rotationX) + Math.abs(d.rotation) > 359.9 && (d.rotationX = d.rotation = 0, d.rotationY = 180 - d.rotationY),
                    d.scaleX = (Math.sqrt(T * T + C * C) * m + .5 | 0) / m,
                    d.scaleY = (Math.sqrt($ * $ + E * E) * m + .5 | 0) / m,
                    d.scaleZ = (Math.sqrt(O * O + z * z) * m + .5 | 0) / m,
                    d.rotationX || d.rotationY ? d.skewX = 0 : (d.skewX = P || $ ? Math.atan2(P, $) * M + d.rotation: d.skewX || 0, Math.abs(d.skewX) > 90 && Math.abs(d.skewX) < 270 && (f ? (d.scaleX *= -1, d.skewX += d.rotation <= 0 ? 180 : -180, d.rotation += d.rotation <= 0 ? 180 : -180) : (d.scaleY *= -1, d.skewX += d.skewX <= 0 ? 180 : -180))),
                    d.perspective = I ? 1 / (0 > I ? -I: I) : 0,
                    d.x = R,
                    d.y = D,
                    d.z = L,
                    d.svg && (d.x -= d.xOrigin - (d.xOrigin * T - d.yOrigin * P), d.y -= d.yOrigin - (d.yOrigin * C - d.xOrigin * $))
                    ...
                    l = Math.sqrt(q * q + H * H),
                    u = Math.sqrt(W * W + B * B),
                    c = q || H ? Math.atan2(H, q) * M: d.rotation || 0,
                    h = B || W ? Math.atan2(B, W) * M + c: d.skewX || 0,
                    Math.abs(h) > 90 && Math.abs(h) < 270 && (f ? (l *= -1, h += 0 >= c ? 180 : -180, c += 0 >= c ? 180 : -180) : (u *= -1, h += 0 >= h ? 180 : -180)),
                    d.scaleX = l,
                    d.scaleY = u,
                    d.rotation = c,
                    d.skewX = h,
                    At && (d.rotationX = d.rotationY = d.z = 0, d.perspective = v, d.scaleZ = 1),
                    d.svg && (d.x -= d.xOrigin - (d.xOrigin * q + d.yOrigin * B), d.y -= d.yOrigin - (d.xOrigin * H + d.yOrigin * W))
                }
                d.zOrigin = g;
                for (a in d) d[a] < p && d[a] > -p && (d[a] = 0)
            }
            return n && (t._gsTransform = d, d.svg && (kt && t.style[Pt] ? e.delayedCall(.001,
            function() {
                Vt(t.style, Pt)
            }) : !kt && t.getAttribute("transform") && e.delayedCall(.001,
            function() {
        ...
        Ht = function(t) {
            ...
            if (d) {
                ...
                if (null != n.ox && (f = (n.oxp ? g * n.ox * .01 : n.ox) - g / 2, p = (n.oyp ? v * n.oy * .01 : n.oy) - v / 2, w += f - (f * a + p * l), b += p - (f * u + p * c)), y ? (f = g / 2, p = v / 2, _ += ", Dx=" + (f - (f * a + p * l) + w) + ", Dy=" + (p - (f * u + p * c) + b) + ")") : _ += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? h.filter = e.replace(z, _) : h.filter = _ + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === u && 1 === c && (y && -1 === _.indexOf("Dx=0, Dy=0") || T.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && h.removeAttribute("filter")), !y) {
                    var C, k, S, P = 8 > m ? 1 : -1;
                    for (f = n.ieOffsetX || 0, p = n.ieOffsetY || 0, n.ieOffsetX = Math.round((g - ((0 > a ? -a: a) * g + (0 > l ? -l: l) * v)) / 2 + w), n.ieOffsetY = Math.round((v - ((0 > c ? -c: c) * v + (0 > u ? -u: u) * g)) / 2 + b), bt = 0; 4 > bt; bt++) k = rt[bt],
                    C = d[k],
                    i = -1 !== C.indexOf("px") ? parseFloat(C) : J(this.t, k, parseFloat(C), C.replace(x, "")) || 0,
                    S = i !== n[k] ? 2 > bt ? -n.ieOffsetX: -n.ieOffsetY: 2 > bt ? f - n.ieOffsetX: p - n.ieOffsetY,
                    h[k] = (n[k] = Math.round(i - S * (0 === bt || 2 === bt ? 1 : P))) + "px"
                }
            }
        },
        Bt = B.set3DTransformRatio = B.setTransformRatio = function(t) {
            var e, i, n, r, o, s, a, l, u, c, h, d, p, m, g, v, y, _, w, b, x, T, C, k = this.data,
            S = this.t.style,
            P = k.rotation,
            $ = k.rotationX,
            O = k.rotationY,
            ...
            I = k.perspective,
            j = k.force3D;
            if (((1 === t || 0 === t) && "auto" === j && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !j) && !D && !I && !O && !$ && 1 === E || kt && M || !At) return void(P || k.skewX || M ? (P *= L, T = k.skewX * L, C = 1e5, e = Math.cos(P) * A, r = Math.sin(P) * A, i = Math.sin(P - T) * -F, o = Math.cos(P - T) * F, T && "simple" === k.skewType && (y = Math.tan(T - k.skewY * L), y = Math.sqrt(1 + y * y), i *= y, o *= y, k.skewY && (y = Math.tan(k.skewY * L), y = Math.sqrt(1 + y * y), e *= y, r *= y)), M && (z += k.xOrigin - (k.xOrigin * e + k.yOrigin * i) + k.xOffset, R += k.yOrigin - (k.xOrigin * r + k.yOrigin * o) + k.yOffset, kt && (k.xPercent || k.yPercent) && (m = this.t.getBBox(), z += .01 * k.xPercent * m.width, R += .01 * k.yPercent * m.height), m = 1e-6, m > z && z > -m && (z = 0), m > R && R > -m && (R = 0)), w = (e * C | 0) / C + "," + (r * C | 0) / C + "," + (i * C | 0) / C + "," + (o * C | 0) / C + "," + z + "," + R + ")", M && kt ? this.t.setAttribute("transform", "matrix(" + w) : S[Pt] = (k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) matrix(": "matrix(") + w) : S[Pt] = (k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) matrix(": "matrix(") + A + ",0,0," + F + "," + z + "," + R + ")");
            if (f && (m = 1e-4, m > A && A > -m && (A = E = 2e-5), m > F && F > -m && (F = E = 2e-5), !I || k.z || k.rotationX || k.rotationY || (I = 0)), P || k.skewX) P *= L,
            g = e = Math.cos(P),
            v = r = Math.sin(P),
            k.skewX && (P -= k.skewX * L, g = Math.cos(P), v = Math.sin(P), "simple" === k.skewType && (y = Math.tan((k.skewX - k.skewY) * L), y = Math.sqrt(1 + y * y), g *= y, v *= y, k.skewY && (y = Math.tan(k.skewY * L), y = Math.sqrt(1 + y * y), e *= y, r *= y))),
            i = -v,
            o = g;
            else {
            ...
            x = "0",
            P = O * L,
            P && (g = Math.cos(P), v = Math.sin(P), a = -v, c = d * -v, n = e * v, s = r * v, u = g, d *= g, e *= g, r *= g),
            P = $ * L,
            P && (g = Math.cos(P), v = Math.sin(P), y = i * g + n * v, _ = o * g + s * v, l = u * v, h = d * v, n = i * -v + n * g, s = o * -v + s * g, u *= g, d *= g, i = y, o = _),
            1 !== E && (n *= E, s *= E, u *= E, d *= E),
            1 !== F && (i *= F, o *= F, l *= F, h *= F),
            1 !== A && (e *= A, r *= A, a *= A, c *= A),
            (p || M) && (p && (z += n * -p, R += s * -p, D += u * -p + p), M && (z += k.xOrigin - (k.xOrigin * e + k.yOrigin * i) + k.xOffset, R += k.yOrigin - (k.xOrigin * r + k.yOrigin * o) + k.yOffset), m > z && z > -m && (z = x), m > R && R > -m && (R = x), m > D && D > -m && (D = 0)),
            w = k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) matrix3d(": "matrix3d(",
            w += (m > e && e > -m ? x: e) + b + (m > r && r > -m ? x: r) + b + (m > a && a > -m ? x: a),
            w += b + (m > c && c > -m ? x: c) + b + (m > i && i > -m ? x: i) + b + (m > o && o > -m ? x: o),
            $ || O || 1 !== E ? (w += b + (m > l && l > -m ? x: l) + b + (m > h && h > -m ? x: h) + b + (m > n && n > -m ? x: n), w += b + (m > s && s > -m ? x: s) + b + (m > u && u > -m ? x: u) + b + (m > d && d > -m ? x: d) + b) : w += ",0,0,0,0,1,0,",
            w += z + b + R + b + D + b + (I ? 1 + -D / I: 1) + ")",
            S[Pt] = w
        };
        u = Ft.prototype,
        ...
        Tt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(t, e, i, n, o, a, l) {
                ...
                var c, h, d, f, p, m, y, _, w, b = t._gsTransform,
                x = t.style,
                T = 1e-6,
                C = St.length,
                k = l,
                ...
                if (n._transform = $, O && "string" == typeof O && Pt) h = q.style,
                h[Pt] = O,
                h.display = "block",
                h.position = "absolute",
                j.body.appendChild(q),
                c = qt(q, null, !1),
                $.svg && (m = $.xOrigin, y = $.yOrigin, c.x -= $.xOffset, c.y -= $.yOffset, (k.transformOrigin || k.svgOrigin) && (O = {},
                Lt(t, st(k.transformOrigin), O, k.svgOrigin, k.smoothOrigin, !0), m = O.xOrigin, y = O.yOrigin, c.x -= O.xOffset - $.xOffset, c.y -= O.yOffset - $.yOffset), (m || y) && (_ = Nt(q, !0), c.x -= m - (m * _[0] + y * _[2]), c.y -= y - (m * _[1] + y * _[3]))),
                j.body.removeChild(q),
                c.perspective || (c.perspective = $.perspective),
                null != k.xPercent && (c.xPercent = lt(k.xPercent, $.xPercent)),
                null != k.yPercent && (c.yPercent = lt(k.yPercent, $.yPercent));
                    ...
                    "string" == typeof k.x && -1 !== k.x.indexOf("%") && (c.x = 0, c.xPercent = lt(k.x, $.xPercent)),
                    "string" == typeof k.y && -1 !== k.y.indexOf("%") && (c.y = 0, c.yPercent = lt(k.y, $.yPercent)),
                    c.rotation = ut("rotation" in k ? k.rotation: "shortRotation" in k ? k.shortRotation + "_short": "rotationZ" in k ? k.rotationZ: $.rotation - $.skewY, $.rotation - $.skewY, "rotation", S),
                    At && (c.rotationX = ut("rotationX" in k ? k.rotationX: "shortRotationX" in k ? k.shortRotationX + "_short": $.rotationX || 0, $.rotationX, "rotationX", S), c.rotationY = ut("rotationY" in k ? k.rotationY: "shortRotationY" in k ? k.shortRotationY + "_short": $.rotationY || 0, $.rotationY, "rotationY", S)),
                    c.skewX = ut(k.skewX, $.skewX - $.skewY),
                    (c.skewY = ut(k.skewY, $.skewY)) && (c.skewX += c.skewY, c.rotation += c.skewY)
                }
                for (At && null != k.force3D && ($.force3D = k.force3D, f = !0), $.skewType = k.skewType || $.skewType || s.defaultSkewType, d = $.force3D || $.z || $.rotationX || $.rotationY || c.z || c.rotationX || c.rotationY || c.perspective, d || null == k.scale || (c.scaleZ = 1); --C > -1;) w = St[C],
                O = c[w] - $[w],
                (O > T || -T > O || null != k[w] || null != I[w]) && (f = !0, o = new yt($, w, $[w], O, o), w in S && (o.e = S[w]), o.xs0 = 0, o.plugin = a, n._overwriteProps.push(o.n));
                return O = k.transformOrigin,
                $.svg && (O || k.svgOrigin) && (m = $.xOffset, y = $.yOffset, Lt(t, st(O), c, k.svgOrigin, k.smoothOrigin), o = _t($, "xOrigin", (b ? $: c).xOrigin, c.xOrigin, o, P), o = _t($, "yOrigin", (b ? $: c).yOrigin, c.yOrigin, o, P), (m !== $.xOffset || y !== $.yOffset) && (o = _t($, "xOffset", b ? m: $.xOffset, $.xOffset, o, P), o = _t($, "yOffset", b ? y: $.yOffset, $.yOffset, o, P)), O = kt ? null: "0px 0px"),
                (O || At && d && $.zOrigin) && (Pt ? (f = !0, w = Ot, O = (O || K(t, w, r, !1, "50% 50%")) + "", o = new yt(x, w, 0, 0, o, -1, P), o.b = x[w], o.plugin = a, At ? (h = $.zOrigin, O = O.split(" "), $.zOrigin = (O.length > 2 && (0 === h || "0px" !== O[2]) ? parseFloat(O[2]) : h) || 0, o.xs0 = o.e = O[0] + " " + (O[1] || "50%") + " 0px", o = new yt($, "zOrigin", 0, 0, o, -1, o.n), o.b = h, o.xs0 = o.e = $.zOrigin) : o.xs0 = o.e = O) : st(O + "", $)),
                f && (n._transformType = $.svg && kt || !d && 3 !== this._transformType ? 2 : 3),
                u && (l[i] = u),
                o
            },
            prefix: !0
        ...
        Tt("borderRadius", {
            ...
            parser: function(t, e, i, o, s, a) {
                e = this.format(e);
                var l, u, c, h, d, f, p, m, g, v, y, _, w, b, x, T, C = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                k = t.style;
                for (g = parseFloat(t.offsetWidth), v = parseFloat(t.offsetHeight), l = e.split(" "), u = 0; u < C.length; u++) this.p.indexOf("border") && (C[u] = G(C[u])),
                d = h = K(t, C[u], r, !1, "0px"),
                ...
                _ = d.substr((p + "").length),
                w = "=" === f.charAt(1),
                w ? (m = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), m *= parseFloat(f), y = f.substr((m + "").length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(f), y = f.substr((m + "").length)),
                "" === y && (y = n[i] || _),
                y !== _ && (b = J(t, "borderLeft", p, _), x = J(t, "borderTop", p, _), "%" === y ? (d = b / g * 100 + "%", h = x / v * 100 + "%") : "em" === y ? (T = J(t, "borderLeft", 1, "em"), d = b / T + "em", h = x / T + "em") : (d = b + "px", h = x + "px"), w && (f = parseFloat(d) + m + y, c = parseFloat(h) + m + y)),
                s = wt(k, C[u], d + " " + h, f + " " + c, !1, "0px", s);
                return s
            },
            prefix: !0,
        ...
        Tt("backgroundPosition", {
            ...
            parser: function(t, e, i, n, o, s) {
                ...
                if ( - 1 !== g.indexOf("%") != ( - 1 !== v.indexOf("%")) && v.split(",").length < 2 && (d = K(t, "backgroundImage").replace(O, ""), d && "none" !== d)) {
                    for (a = g.split(" "), l = v.split(" "), H.setAttribute("src", d), u = 2; --u > -1;) g = a[u],
                    c = -1 !== g.indexOf("%"),
                    c !== ( - 1 !== l[u].indexOf("%")) && (h = 0 === u ? t.offsetWidth - H.width: t.offsetHeight - H.height, a[u] = c ? parseFloat(g) / 100 * h + "px": parseFloat(g) / h * 100 + "%");
                    g = a.join(" ")
                }
        ...
        Tt("clip", {
            ...
            parser: function(t, e, i, n, o, s) {
                var a, l, u;
                return 9 > m ? (l = t.currentStyle, u = 8 > m ? " ": ",", a = "rect(" + l.clipTop + u + l.clipRight + u + l.clipBottom + u + l.clipLeft + ")", e = this.format(e).split(",").join(u)) : (a = this.format(K(t, this.p, r, !1, this.dflt)), e = this.format(e)),
        ...
        Tt("border", {
            ...
            parser: function(t, e, i, n, o, s) {
                ...
                this.parseComplex(t.style, this.format(a + " " + K(t, "borderTopStyle", r, !1, "solid") + " " + K(t, "borderTopColor", r, !1, "#000")), l.join(" "), o, s)
            },
            color: !0,
            formatter: function(t) {
                var e = t.split(" ");
        ...
        var Wt = function(t) {
            ...
            r = this.s + this.c * t | 0;
            100 === r && ( - 1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), e = !K(this.data, "filter")) : (i.filter = n.replace(k, ""), e = !0)),
        ...
        Tt("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, n, o, s) {
                ...
                u && 1 === a && "hidden" === K(t, "visibility", r) && 0 !== e && (a = 0),
                V ? o = new yt(l, "opacity", a, e - a, o) : (o = new yt(l, "opacity", 100 * a, 100 * (e - a), o), o.xn1 = u ? 1 : 0, l.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = t, o.plugin = s, o.setRatio = Wt),
                u && (o = new yt(l, "visibility", 0, 0, o, -1, null, !1, 0, 0 !== a ? "inherit": "hidden", 0 === e ? "hidden": "inherit"), o.xs0 = "inherit", n._overwriteProps.push(o.n), n._overwriteProps.push(i)),
                o
            }
        });
        var Vt = function(t, e) {
        ...
        }), u = "bezier,throwProps,physicsProps,physics2D".split(","), bt = u.length; bt--;) Ct(u[bt]);
        u = s.prototype,
        ...
        u._onInitTween = function(t, e, a, u) {
            ...
            var f, m, y, _, w, b, x, T, k, S = t.style;
            if (h && "" === S.zIndex && (f = K(t, "zIndex", r), ("auto" === f || "" === f) && this._addLazySet(S, "zIndex", 0)), "string" == typeof e && (_ = S.cssText, f = et(t, r), S.cssText = _ + ";" + e, f = it(t, f, et(t)).difs, !V && C.test(e) && (f.opacity = parseFloat(RegExp.$1)), e = f, S.cssText = _), e.className ? this._firstPT = m = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = m = this.parse(t, e, null), this._transformType) {
                ...
                T.setRatio = Pt ? Bt: Ht,
                T.data = this._transform || qt(t, r, !0),
                T.tween = a,
                T.pr = -1,
                o.pop()
            }
        ...
        u.parse = function(t, e, i, o) {
            var s, a, u, h, d, f, p, m, y, _, w = t.style;
            for (s in e) f = e[s],
            "function" == typeof f && (f = f(v, g)),
            a = l[s],
            a ? i = a.parse(t, f, s, this, i, o, e) : (d = K(t, s, r) + "", y = "string" == typeof f, "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || y && S.test(f) ? (y || (f = dt(f), f = (f.length > 3 ? "rgba(": "rgb(") + f.join(",") + ")"), i = wt(w, s, d, f, !0, "transparent", i, 0, o)) : y && D.test(f) ? i = wt(w, s, d, f, !0, null, i, 0, o) : (u = parseFloat(d), p = u || 0 === u ? d.substr((u + "").length) : "", ("" === d || "auto" === d) && ("width" === s || "height" === s ? (u = ot(t, s, r), p = "px") : "left" === s || "top" === s ? (u = tt(t, s, r), p = "px") : (u = "opacity" !== s ? 0 : 1, p = "")), _ = y && "=" === f.charAt(1), _ ? (h = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), h *= parseFloat(f), m = f.replace(x, "")) : (h = parseFloat(f), m = y ? f.replace(x, "") : ""), "" === m && (m = s in n ? n[s] : p), f = h || 0 === h ? (_ ? h + u: h) + m: e[s], p !== m && "" !== m && (h || 0 === h) && u && (u = J(t, s, u, p), "%" === m ? (u /= J(t, s, 100, "%") / 100, e.strictUnits !== !0 && (d = u + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? u /= J(t, s, 1, m) : "px" !== m && (h = J(t, s, h, m), m = "px"), _ && (h || 0 === h) && (f = h + u + m)), _ && (h += u), !u && 0 !== u || !h && 0 !== h ? void 0 !== w[s] && (f || f + "" != "NaN" && null != f) ? (i = new yt(w, s, h || u || 0, 0, i, -1, s, !1, 0, d, f), i.xs0 = "none" !== f || "display" !== s && -1 === s.indexOf("Style") ? f: d) : X("invalid " + s + " tween value: " + e[s]) : (i = new yt(w, s, u, h - u, i, 0, s, c !== !1 && ("px" === m || "zIndex" === s), 0, d, f), i.xs0 = m))),
        ...
        var Qt = function(t, e, i) {
            ...
            else for (n = t.childNodes, r = n.length; --r > -1;) o = n[r],
            s = o.type,
            o.style && (e.push(et(o)), i && i.push(o)),
            1 !== s && 9 !== s && 11 !== s || !o.childNodes.length || Qt(o, e, i)
        };
    ...
    function() {
        ...
        i._onInitAllProps = function() {
            ...
            o = r.vars.roundProps.join ? r.vars.roundProps: r.vars.roundProps.split(","), s = o.length, a = {},
            l = r._propLookup.roundProps; --s > -1;) a[o[s]] = Math.round;
            for (s = o.length; --s > -1;) for (t = o[s], i = r._firstPT; i;) n = i._next,
            i.pg ? i.t._mod(a) : i.n === t && (2 === i.f && i.t ? e(i.t._firstPT) : (this._add(i.t, t, i.s, i.c), n && (n._prev = i._prev), i._prev ? i._prev._next = n: r._firstPT === i && (r._firstPT = n), i._next = i._prev = null, r._propLookup[t] = l)),
            i = n;
            return ! 1
        },
    ...
    function(t) {
        ...
        function(e) {
            e = e || {};
            for (var i, n, r, o, s, a, l = e.taper || "none",
            u = [], c = 0, h = 0 | (e.points || 20), f = h, p = e.randomize !== !1, m = e.clamp === !0, g = e.template instanceof t ? e.template: null, v = "number" == typeof e.strength ? .4 * e.strength: .4; --f > -1;) i = p ? Math.random() : 1 / h * f,
            n = g ? g.getRatio(i) : i,
            "none" === l ? r = v: "out" === l ? (o = 1 - i, r = o * o * v) : "in" === l ? r = i * i * v: .5 > i ? (o = 2 * i, r = o * o * .5 * v) : (o = 2 * (1 - i), r = o * o * .5 * v),
            p ? n += Math.random() * r - .5 * r: f % 2 ? n += .5 * r: n -= .5 * r,
            m && (n > 1 ? n = 1 : 0 > n && (n = 0)),
            u[c++] = {
                x: i,
                y: n
            ...
            for (u.sort(function(t, e) {
                return t.x - e.x
            }), a = new d(1, 1, null), f = h; --f > -1;) s = u[f],
            a = new d(s.x, s.y, a);
    ...
    if (!n.TweenLite) {
        ...
        g = function(r, o, s, a) {
            ...
            this.check = function(c) {
                for (var h, d, f, p, v, y = o.length,
                _ = y; --y > -1;)(h = m[o[y]] || new g(o[y], [])).gsClass ? (l[y] = h.gsClass, _--) : c && h.sc.push(this);
                if (0 === _ && s) {
                    if (d = ("com.greensock." + r).split("."), f = d.pop(), p = u(d.join("."))[f] = this.gsClass = s.apply(s, l), a) if (n[f] = i[f] = p, v = "undefined" != typeof module && module.exports, !v && "function" == typeof define && define.amd) define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/": "") + r.split(".").pop(), [],
                    function() {
                        return p
                    });
                    else if (v) if (r === e) {
        ...
        x = w.register = function(t, e, i, n) {
            for (var r, o, s, a, l = e.split(","), u = l.length, h = (i || "easeIn,easeOut,easeInOut").split(","); --u > -1;) for (o = l[u], r = n ? y("easing." + o, null, !0) : c.easing[o] || {},
            s = h.length; --s > -1;) a = h[s],
            b[o + "." + a] = b[a + o] = r[a] = t.getRatio ? t: t[a] || new t
        };
        ...
        r = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"], o = r.length; --o > -1;) s = r[o] + ",Power" + o,
        x(new w(null, null, 1, o), s, "easeOut", !0),
        x(new w(null, null, 2, o), s, "easeIn" + (0 === o ? ",easeNone": "")),
        x(new w(null, null, 3, o), s, "easeInOut");
        b.linear = c.easing.Linear.easeIn,
        b.swing = c.easing.Quad.easeInOut;
        var T = y("events.EventDispatcher",
        function(t) {
            this._listeners = {},
        ...
        s.addEventListener = function(t, e, i, n, r) {
            ...
            c = 0;
            for (this !== a || l || a.wake(), null == u && (this._listeners[t] = u = []), s = u.length; --s > -1;) o = u[s],
        ...
        P = S();
        for (r = ["ms", "moz", "webkit", "o"], o = r.length; --o > -1 && !C;) C = t[r[o] + "RequestAnimationFrame"],
        k = t[r[o] + "CancelAnimationFrame"] || t[r[o] + "CancelRequestAnimationFrame"];
        y("Ticker",
        function(t, e) {
            ...
            v = function(t) {
                ...
                u.time = (P - c) / 1e3,
                e = u.time - s,
                (!i || e > 0 || t === !0) && (u.frame++, s += e + (e >= o ? .004 : o - e), a = !0),
                t !== !0 && (r = n(v)),
                a && u.dispatchEvent(g)
            };
            T.call(u),
            ...
            u.wake = function(t) {
                null !== r ? u.sleep() : t ? c += -P + (P = S()) : u.frame > 10 && (P = S() - p + 5),
                n = 0 === i ? f: d && C ? C: function(t) {
        ...
        s.eventCallback = function(t, e, i, n) {
            if ("on" === (t || "").substr(0, 2)) {
                ...
                null == e ? delete r[t] : (r[t] = e, r[t + "Params"] = p(i) && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i, r[t + "Scope"] = n),
        ...
        s.totalTime = function(t, e, i) {
            ...
            if (this._timeline) {
                ...
                this._gc && this._enabled(!0, !1),
                (this._totalTime !== t || 0 === this._duration) && (R.length && Q(), this.render(t, e, !1), R.length && Q())
            }
            return this
        },
        ...
        s.paused = function(t) {
            ...
            return t != this._paused && n && (l || t || a.wake(), e = n.rawTime(), i = e - this._pauseTime, !t && n.smoothChildTiming && (this._startTime += i, this._uncache(!1)), this._pauseTime = t ? e: null, this._paused = t, this._active = this.isActive(), !t && 0 !== i && this._initted && this.duration() && (e = n.smoothChildTiming ? this._totalTime: (e - this._startTime) / this._timeScale, this.render(e, e === this._totalTime, !0))),
            this._gc && !t && this._enabled(!0, !1),
            this
        };
        var A = y("core.SimpleTimeline",
        function(t) {
            $.call(this, 0, t),
        ...
        function(e, i, n) {
            ...
            if (this._overwrite = l = null == l ? V[F.defaultOverwrite] : "number" == typeof l ? l >> 0 : V[l], (a || e instanceof Array || e.push && p(e)) && "number" != typeof e[0]) for (this._targets = s = d(e), this._propLookup = [], this._siblings = [], r = 0; r < s.length; r++) o = s[r],
            o ? "string" != typeof o ? o.length && o !== t && o[0] && (o[0] === t || o[0].nodeType && o[0].style && !o.nodeType) ? (s.splice(r--, 1), this._targets = s = s.concat(d(o))) : (this._siblings[r] = G(o, this, !1), 1 === l && this._siblings[r].length > 1 && K(o, this, null, 1, this._siblings[r])) : (o = s[r--] = F.selector(o), "string" == typeof o && s.splice(r + 1, 1)) : s.splice(r--, 1);
            else this._propLookup = {},
            this._siblings = G(e, this, !1),
            1 === l && this._siblings.length > 1 && K(e, this, null, 1, this._siblings); (this.vars.immediateRender || 0 === i && 0 === this._delay && this.vars.immediateRender !== !1) && (this._time = -h, this.render(Math.min(0, -this._delay)))
        },
        !0),
        E = function(e) {
        ...
        F.version = "1.19.0",
        F.defaultEase = s._ease = new w(null, null, 1, 1),
        ...
        I = function(t, e, i, n) {
            ...
            f = "",
            p = 0;
            for (h.start = t, i && (i(h), t = h[0], e = h[1]), h.length = 0, r = t.match(L) || [], o = e.match(L) || [], n && (n._next = null, n.blob = 1, h._firstPT = h._applyPT = n), l = o.length, a = 0; l > a; a++) c = o[a],
            u = e.substr(d, e.indexOf(c, d) - d),
            f += u || !a ? u: ",",
            d += u.length,
            p ? p = (p + 1) % 5 : "rgba(" === u.substr( - 5) && (p = 1),
            c === r[a] || r.length <= a ? f += c: (f && (h.push(f), f = ""), s = parseFloat(r[a]), h.push(s), h._firstPT = {
                _next: h._firstPT,
                t: h,
                p: h.length - 1,
                s: s,
        ...
        s._init = function() {
            ...
            if (this._ease = c = c ? c instanceof w ? c: "function" == typeof c ? new w(c, s.easeParams) : b[c] || F.defaultEase: F.defaultEase, s.easeParams instanceof Array && c.config && (this._ease = c.config.apply(c, s.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets) for (o = this._targets.length, t = 0; o > t; t++) this._initProps(this._targets[t], this._propLookup[t] = {},
            this._siblings[t], a ? a[t] : null, t) && (e = !0);
            else e = this._initProps(this.target, this._propLookup, this._siblings, a, 0);
            if (e && F._onPluginEvent("_onInitAllProps", this), a && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), s.runBackwards) for (i = this._firstPT; i;) i.s += i.c,
            i.c = -i.c,
            i = i._next;
        ...
        s._initProps = function(e, i, n, r, o) {
            ...
            if (null == e) return ! 1;
            D[e._gsTweenID] && Q(),
            this.vars.css || e.style && e !== t && e.nodeType && q.css && this.vars.autoCSS !== !1 && z(this.vars, e);
            for (s in this.vars) if (h = this.vars[s], W[s]) h && (h instanceof Array || h.push && p(h)) && -1 !== h.join("").indexOf("{self}") && (this.vars[s] = h = this._swapSelfInParams(h, this));
                ...
                a = u._overwriteProps.length; --a > -1;) i[u._overwriteProps[a]] = this._firstPT; (u._priority || u._onInitAllProps) && (l = !0),
        ...
        s.render = function(t, e, i) {
            ...
            0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > u || 0 >= t && t >= -1e-7 || u === h && "isPause" !== this.data) && u !== t && (i = !0, u > h && (r = "onReverseComplete")), this._rawPrevTime = s = !e || t || u === t ? t: h);
            else if (1e-7 > t) this._totalTime = this._time = 0,
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
            (0 !== a || 0 === l && u > 0) && (r = "onReverseComplete", n = this._reversed),
            0 > t && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (u >= 0 && (u !== h || "isPause" !== this.data) && (i = !0), this._rawPrevTime = s = !e || t || u === t ? t: h)),
            this._initted || (i = !0);
            else if (this._totalTime = this._time = t, this._easeType) {
                var c = t / l,
                d = this._easeType,
                f = this._easePower; (1 === d || 3 === d && c >= .5) && (c = 1 - c),
                3 === d && (c *= 2),
                1 === f ? c *= c: 2 === f ? c *= c * c: 3 === f ? c *= c * c * c: 4 === f && (c *= c * c * c * c),
                1 === d ? this.ratio = 1 - c: 2 === d ? this.ratio = c: .5 > t / l ? this.ratio = c / 2 : this.ratio = 1 - c / 2
            ...
            if (this._time !== a || i) {
                ...
                for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== a && t >= 0 && (this._active = !0), 0 === a && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._time || 0 === l) && (e || this._callback("onStart"))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s,
                o = o._next;
                this._onUpdate && (0 > t && this._startAt && t !== -1e-4 && this._startAt.render(t, e, i), e || (this._time !== a || n || i) && this._callback("onUpdate")),
                r && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && t !== -1e-4 && this._startAt.render(t, e, i), n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[r] && this._callback(r), 0 === l && this._rawPrevTime === h && s !== h && (this._rawPrevTime = 0))
            }
        },
        s._kill = function(t, e, i) {
            ...
            if ((p(e) || E(e)) && "number" != typeof e[0]) for (n = e.length; --n > -1;) this._kill(t, e[n], i) && (l = !0);
                ...
                if (a) {
                    ...
                    for (o in u)(s = a[o]) && (d && (s.f ? s.t[s.p](s.s) : s.t[s.p] = s.s, l = !0), s.pg && s.t._kill(u) && (l = !0), s.pg && 0 !== s.t._overwriteProps.length || (s._prev ? s._prev._next = s._next: s === this._firstPT && (this._firstPT = s._next), s._next && (s._next._prev = s._prev), s._next = s._prev = null), delete a[o]),
                    c && (r[o] = 1); ! this._firstPT && this._initted && this._enabled(!1, !1)
                }
            }
            return l
        },
        ...
        s._enabled = function(t, e) {
            ...
            this._notifyPluginsOfEnabled && this._firstPT ? F._onPluginEvent(t ? "_onEnable": "_onDisable", this) : !1
        },
        F.to = function(t, e, i) {
            return new F(t, e, i)
        },
        ...
        v.plugin = function(t) {
            ...
            s = y("plugins." + i.charAt(0).toUpperCase() + i.substr(1) + "Plugin",
            function() {
                tt.call(this, i, n),
...
function() {
    ...
    t.Controller = function(n) {
        ...
        b = function() {
            ...
            y = f.container === window || f.container === document.body || !document.body.contains(f.container),
            y && (f.container = window),
            _ = C(),
            f.container.addEventListener("resize", $),
            f.container.addEventListener("scroll", $),
            f.refreshInterval = parseInt(f.refreshInterval) || h.refreshInterval,
            x()
        },
        x = function() {
        ...
        this.updateScene = function(e, i) {
            return r.type.Array(e) ? e.forEach(function(t) {
                d.updateScene(t, i)
            }) : i ? e.update(!0) : m !== !0 && e instanceof t.Scene && (m = m || [], -1 == m.indexOf(e) && m.push(e), m = A(m), P()),
            d
        },
        ...
        this.enabled = function(t) {
            return arguments.length ? (w != t && (w = !!t, d.updateScene(p, !0)), d) : w
        },
        this.destroy = function(t) {
            window.clearTimeout(s);
            for (var e = p.length; e--;) p[e].destroy(t);
            return f.container.removeEventListener("resize", $),
            f.container.removeEventListener("scroll", $),
            r.cAF(o),
            null
        },
        b(),
    ...
    t.Scene = function(i) {
            ...
            return t ? (t = t.trim().split(" "), t.forEach(function(t) {
                ...
                o.forEach(function(t) {
                    for (var i = _[t] || [], n = i.length; n--;) {
                        var o = i[n]; ! o || r !== o.namespace && "*" !== r || e && e != o.callback || i.splice(n, 1)
                    }
                    i.length || delete _[t]
                })
            }), h) : h
        ...
        this.addTo = function(e) {
            return e instanceof t.Controller && s != e && (s && s.removeScene(h), s = e, k(), b(!0), x(!0), w(), s.info("container").addEventListener("resize", T), e.addScene(h), h.trigger("add", {
                controller: s
            }), h.update()),
            h
        },
        ...
        var w = function() {
            ...
            s && d.triggerElement && (m.start -= s.info("size") * d.triggerHook),
        ...
        S = function(t, e) {
            var i = !1,
            n = d[t];
            return d[t] != e && (d[t] = e, k(t), i = n != d[t]),
            i
        },
        P = function(t) {
            h[t] || (h[t] = function(e) {
        ...
        this.triggerPosition = function() {
            var t = d.offset;
            return s && (t += d.triggerElement ? g: s.info("size") * h.triggerHook()),
            t
        };
        var $, O;
        h.on("shift.internal",
        function(t) {
            var e = "duration" === t.reason; (f === u && e || f === l && 0 === d.duration) && A(),
            e && F()
        ...
        var A = function(t) {
            if ($ && s) {
                ...
                if (t || f !== l) {
                    ...
                    O.pushFollowers ? d.duration > 0 && (f === u && 0 === parseFloat(r.css(O.spacer, "padding-top")) ? o = !0 : f === a && 0 === parseFloat(r.css(O.spacer, "padding-bottom")) && (o = !0)) : n[e.vertical ? "top": "left"] = d.duration * p,
                    r.css(i, n),
                    o && F()
                } else {
        ...
        F = function() {
            if ($ && s && O.inFlow) {
                ...
                O.relSize.width || O.relSize.autoFullWidth ? t ? r.css($, {
                    ...
                    width: "100%"
                }) : (o["min-width"] = r.get.width(e ? $: i, !0, !0), o.width = t ? o["min-width"] : "auto"),
                O.relSize.height ? t ? r.css($, {
                    height: r.get.height(O.spacer) - (O.pushFollowers ? d.duration: 0)
                }) : r.css($, {
                    height: "100%"
                }) : (o["min-height"] = r.get.height(e ? i: $, !0, !n), o.height = t ? o["min-height"] : "auto"),
                O.pushFollowers && (o["padding" + (e ? "Top": "Left")] = d.duration * p, o["padding" + (e ? "Bottom": "Right")] = d.duration * (1 - p)),
                r.css(O.spacer, o)
            }
        },
        E = function() {
        ...
        this.setPin = function(t, i) {
            ...
            if (i = r.extend({},
            n, i), t = r.get.elements(t)[0], !t) return h;
            ...
            $.addEventListener("mousewheel", R),
            $.addEventListener("DOMMouseScroll", R),
            A(),
            h
        },
        this.removePin = function(t) {
            if ($) {
                if (f === l && A(!0), t || !s) {
                    ...
                    O.spacer.parentNode.insertBefore(i, O.spacer),
                    O.spacer.parentNode.removeChild(O.spacer),
                    $.parentNode.hasAttribute(e) || (r.css($, $.___origStyle), delete $.___origStyle)
                }
                window.removeEventListener("scroll", E),
                window.removeEventListener("resize", E),
                window.removeEventListener("resize", z),
                $.removeEventListener("mousewheel", R),
                $.removeEventListener("DOMMouseScroll", R),
                $ = void 0
            }
            return h
        };
        var D, L = [];
        return h.on("destroy.internal",
        function(t) {
            h.removeClassToggle(t.reset)
        }),
        this.setClassToggle = function(t, e) {
            var i = r.get.elements(t);
            return 0 !== i.length && r.type.String(e) ? (L.length > 0 && h.removeClassToggle(), D = e, L = i, h.on("enter.internal_class leave.internal_class",
            function(t) {
    ...
    var r = t._util = function(t) {
        ...
        for (e = 0; ! u && e < l.length; ++e) u = t[l[e] + "RequestAnimationFrame"],
        ...
        return d.elements = function(e) {
            ...
            if ("nodelist" === h(e) || h.Array(e)) for (var r = 0,
            o = i.length = e.length; o > r; r++) {
                var s = e[r];
        ...
        d.offset = function(t, e) {
            ...
            if (t && t.getBoundingClientRect) {
                ...
                i.top = n.top,
                i.left = n.left,
                e || (i.top += d.scrollTop(), i.left += d.scrollLeft())
            }
            return i
        },
...
function(t, e, i) {
    ...
    t.Scene.extend(function() {
        ...
        n.removeTween = function(e) {
            return t && (e && t.progress(0).pause(), t.kill(), t = void 0),
            n
        }
    })
}),
PolygonFactory.prototype.init = function() {
    for (var t = 0; t < this.rowCount; t++) for (var e = 0; e < this.colCount; e++) {
        ...
        n = this.height * e;
        e % 2 === 0 && (i += 130),
        e > 0 && (n += this.gutterY * e),
        t > 0 && (i += this.gutterX * t);
        var r = random( - 30, 30),
        o = random( - 30, 30),
...
uberTitleAnimation = function() {
    ...
    var t = $(t[0]);
    t.prev().addClass("hero-title-carousel-hide"),
...
function(t) {
    ...
    $(".balance-scene-canvas .product-bg").eq(e).addClass("active"),
    $(".balance-scene-container .content").eq(e).addClass("active");
...
populateLanguageChannelSelector = function() {
    ...
    t = _.difference(_.uniq(t), ignoredLangs),
    e = _.uniq(e),
    t.length > 1 ? (_.each(t,
    function(t) {
        $("#language-select").append($("<li><a onclick=\"filterByLanguage('" + t + "')\">" + humanReadableLangs[t] + "</a></li>"))
    }), $(".language-select-item > a").text(t[0]), $(".language-select-item").addClass("on"), filterByLanguage(t[0])) : $(".language-select-item").remove(),
    e.length > 1 ? (_.each(e,
    function(t) {
...
setStickyforPositon = function() {
    function t(t) {
        s = e.scrollTop() + 42,
        a >= s ? ($("ul.team-nav li a").removeClass("active"), $("ul.team-nav li:eq(0) a").addClass("active")) : s > a && l >= s ? ($("ul.team-nav li a").removeClass("active"), $("ul.team-nav li:eq(1) a").addClass("active")) : s > l && u >= s ? ($("ul.team-nav li a").removeClass("active"), $("ul.team-nav li:eq(2) a").addClass("active")) : s > u && c >= s ? ($("ul.team-nav li a").removeClass("active"), $("ul.team-nav li:eq(3) a").addClass("active")) : s > c && ($("ul.team-nav li a").removeClass("active"), $("ul.team-nav li:eq(4) a").addClass("active"))
    }
...
function(t) {
    ...
    t(".pricing-compare").hover(function() {
        e = "." + t(this).attr("class").split(" ").join("."),
        t(e).addClass("on")
    },
    function() {
        t(e).removeClass("on"),
...
var openProductsModal = function(t, e) {
    "undefined" == typeof t && (t = "all"),
    $("body").css({
        "overflow-y": "hidden"
    }),
    $(".gallery-modal").addClass("gallery-modal-open"),
    $("#channelFilters a." + t).trigger("click"),
    "undefined" != typeof e && $(".products-grid").find("." + e).click()
},
...
$(document).ready(function() {
    ...
    setMobileNav(),
    $(window).width() > 760 && (homepageTween(), setStickyNavBar()),
    cmbIntroAnimate(),
    cubeAnimation(),
    slideScene(),
    setInterval(heroCoinDropAnimation, 500),
    setInterval(countdownDropAnimation, 1500),
    setInterval(uberTitleAnimation, 3e3),
    $(".countdown-timer").countdown("2016/04/20 18:00:00",
    function(t) {
        var e = 24 * t.offset.totalDays + t.offset.hours;
        $(this).find(".hours").text(e),
        $(this).find(".minutes").text(t.strftime("%M")),
        $(this).find(".seconds").text(t.strftime("%S"))
    });
    ...
    if (e.indexOf("html") > 0 && (e = e.slice(0, -5)), "customers" === e) {
        ...
        function() {
            var t = function(t) {
                ...
                d = o,
                f = s,
                a > 60 || l > 60 || window.requestAnimationFrame(function() {
            ...
            u = new PolygonFactory(l),
            u.init().renderPolygon(),
            d = 0,
            f = 0,
            p = 1200,
            m = 2e3,
            $("#polygonContainer").on("mouseenter",
            function(t) {
                c = t.pageX,
                h = t.pageY
            }),
            $("#polygonContainer").on("mousemove",
            function(e) {
                t(e)
            }),
            $("#hero .hero-copy").on("mousemove",
            function(e) {
                t(e)
            })
        } ()
        ...
        $("#channelFilters").on("click", "a",
        function() {
            var t = "translate3d(0,0,0)",
            e = "all 0.35s ease-in";
            $(".gallery-modal").scrollTop(0),
            $(".fixed-content-grid").removeClass("opened"),
            ...
            $("#channelFilters a").removeClass("active"),
            $(this).addClass("active"),
            g.filterData(i).render(".gallery-content-pannel .products-grid", "overview").render(".gallery-content-pannel .fixed-content-grid", "detail")
        }),
        ...
        $(".gallery-content-pannel .products-grid").on("click", ".products-grid-item",
        function() {
            var t = $(window).width(),
            e = 0;
            768 > t ? (e = -t, $(".gallery-modal .modal-icon--close").css({
                opacity: "0"
            }), $(".gallery-modal .modal-icon--back").css({
                opacity: "1",
                zIndex: "99"
            })) : t >= 768 && 1024 > t ? e = -200 : t >= 1024 && 1200 > t ? e = -220 : t >= 1200 && (e = -250),
            ...
            $(".fixed-content-grid").foundation(),
            $(".fixed-content-grid").addClass("opened"),
            $(".products-detail-grid-item").removeClass("active"),
            $("#" + i).addClass("active")
        })
    } else if ("contact" === e) {
    ...
    $(".docs-article-select-toggle").on("click",
    function(t) {
        $(".docs-article-select").toggleClass("on")
    }),
    populateLanguageChannelSelector(),
    $(document).on("formvalid.zf.abide",
    function(t, e) {
        var i = e.serialize();
        $("#submit").hasClass("disabled") ? console.log("already send") : $.ajax({
            method: "POST",
            url: "#",
            data: i,
            dataType: "json"
        }).done(function() {
            $("#submit").text("é‚®ä»¶å‘é€æˆåŠŸ").addClass("disabled")
        }).fail(function() {
            $("#submit").text("å‘é€å¤±è´¥")
        })
    }).on("submit",
